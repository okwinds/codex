...
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/common.rs:480` | `pub enum ServerRequest {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/common.rs:493` | `pub enum ServerRequestPayload {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:498` | `pub fn request_with_id(self, request_id: RequestId) -> ServerRequest {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:505` | `pub fn export_server_responses(` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:515` | `pub fn export_server_response_schemas(` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:529` | `pub fn export_server_param_schemas(` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/common.rs:557` | `pub enum ServerNotification {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:566` | `pub fn to_params(self) -> Result<serde_json::Value, serde_json::Error> {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:582` | `pub fn export_server_notification_schemas(` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/common.rs:602` | `pub enum ClientNotification {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/common.rs:609` | `pub fn export_client_notification_schemas(` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/common.rs:678` | `pub struct FuzzyFileSearchParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/common.rs:687` | `pub struct FuzzyFileSearchResult {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/common.rs:696` | `pub struct FuzzyFileSearchResponse {` |
...
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:380` | `pub enum AppDisabledReason {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:388` | `pub struct AppConfig {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:397` | `pub struct AppsConfig {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:410` | `pub struct Config {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:443` | `pub struct ConfigLayerMetadata {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:451` | `pub struct ConfigLayer {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:462` | `pub enum MergeStrategy {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:470` | `pub enum WriteStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:478` | `pub struct OverriddenMetadata {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:487` | `pub struct ConfigWriteResponse {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:498` | `pub enum ConfigWriteErrorCode {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:510` | `pub struct ConfigReadParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:523` | `pub struct ConfigReadResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:533` | `pub struct ConfigRequirements {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:545` | `pub struct NetworkRequirements {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:561` | `pub enum ResidencyRequirement {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:568` | `pub struct ConfigRequirementsReadResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:576` | `pub struct ConfigValueWriteParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:590` | `pub struct ConfigBatchWriteParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:602` | `pub struct ConfigEdit {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:611` | `pub enum CommandExecutionApprovalDecision {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:630` | `pub enum FileChangeApprovalDecision {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:644` | `pub enum NetworkAccess {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:654` | `pub enum SandboxPolicy {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:678` | `pub fn to_core(&self) -> codex_protocol::protocol::SandboxPolicy {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:740` | `pub struct ExecPolicyAmendment {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:745` | `pub fn into_core(self) -> CoreExecPolicyAmendment {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:762` | `pub enum CommandAction {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:786` | `pub enum SessionSource {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:828` | `pub struct GitInfo {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:835` | `pub fn into_core(self) -> CoreParsedCommand {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:880` | `pub enum Account {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:894` | `pub enum LoginAccountParams {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:930` | `pub enum LoginAccountResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:951` | `pub struct CancelLoginAccountParams {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:959` | `pub enum CancelLoginAccountStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:967` | `pub struct CancelLoginAccountResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:974` | `pub struct LogoutAccountResponse {}` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:979` | `pub enum ChatgptAuthTokensRefreshReason {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:987` | `pub struct ChatgptAuthTokensRefreshParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1003` | `pub struct ChatgptAuthTokensRefreshResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1011` | `pub struct GetAccountRateLimitsResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1018` | `pub struct GetAccountParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1031` | `pub struct GetAccountResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1039` | `pub struct ModelListParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1051` | `pub struct Model {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1070` | `pub struct ReasoningEffortOption {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1078` | `pub struct ModelListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1089` | `pub struct CollaborationModeListParams {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1095` | `pub struct CollaborationModeListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1102` | `pub struct ExperimentalFeatureListParams {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1114` | `pub enum ExperimentalFeatureStage {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1130` | `pub struct ExperimentalFeature {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1153` | `pub struct ExperimentalFeatureListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1163` | `pub struct ListMcpServerStatusParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1175` | `pub struct McpServerStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1186` | `pub struct ListMcpServerStatusResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1196` | `pub struct AppsListParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1208` | `pub struct AppInfo {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1223` | `pub struct AppsListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1233` | `pub struct McpServerRefreshParams {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1238` | `pub struct McpServerRefreshResponse {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1243` | `pub struct McpServerOauthLoginParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1256` | `pub struct McpServerOauthLoginResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1263` | `pub struct FeedbackUploadParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1275` | `pub struct FeedbackUploadResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1282` | `pub struct CommandExecParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1296` | `pub struct CommandExecResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1309` | `pub struct ThreadStartParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1348` | `pub struct MockExperimentalMethodParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1357` | `pub struct MockExperimentalMethodResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1365` | `pub struct ThreadStartResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1389` | `pub struct ThreadResumeParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1429` | `pub struct ThreadResumeResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1451` | `pub struct ThreadForkParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1482` | `pub struct ThreadForkResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1495` | `pub struct ThreadArchiveParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1502` | `pub struct ThreadArchiveResponse {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1507` | `pub struct ThreadSetNameParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1515` | `pub struct ThreadUnarchiveParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1522` | `pub struct ThreadSetNameResponse {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1527` | `pub struct ThreadUnarchiveResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1534` | `pub struct ThreadCompactStartParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1541` | `pub struct ThreadCompactStartResponse {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1546` | `pub struct ThreadRollbackParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1558` | `pub struct ThreadRollbackResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1570` | `pub struct ThreadListParams {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1597` | `pub enum ThreadSourceKind {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1615` | `pub enum ThreadSortKey {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1623` | `pub struct ThreadListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1633` | `pub struct ThreadLoadedListParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1645` | `pub struct ThreadLoadedListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1656` | `pub struct ThreadReadParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1666` | `pub struct ThreadReadResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1673` | `pub struct SkillsListParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1686` | `pub struct SkillsListResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1693` | `pub struct SkillsRemoteReadParams {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1698` | `pub struct RemoteSkillSummary {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1707` | `pub struct SkillsRemoteReadResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1714` | `pub struct SkillsRemoteWriteParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1722` | `pub struct SkillsRemoteWriteResponse {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1732` | `pub enum SkillScope {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1742` | `pub struct SkillMetadata {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1763` | `pub struct SkillInterface {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1781` | `pub struct SkillDependencies {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1788` | `pub struct SkillToolDependency {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1810` | `pub struct SkillErrorInfo {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1818` | `pub struct SkillsListEntry {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1827` | `pub struct SkillsConfigWriteParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1835` | `pub struct SkillsConfigWriteResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1915` | `pub struct Thread {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1947` | `pub struct AccountUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1954` | `pub struct ThreadTokenUsageUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1963` | `pub struct ThreadTokenUsage {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:1984` | `pub struct TokenUsageBreakdown {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2012` | `pub struct Turn {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2027` | `pub struct TurnError {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2037` | `pub struct ErrorNotification {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2049` | `pub enum TurnStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2062` | `pub struct TurnStartParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2103` | `pub struct ReviewStartParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2117` | `pub struct ReviewStartResponse {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2129` | `pub enum ReviewTarget {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2156` | `pub struct TurnStartResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2163` | `pub struct TurnSteerParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2174` | `pub struct TurnSteerResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2181` | `pub struct TurnInterruptParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2189` | `pub struct TurnInterruptResponse {}` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2195` | `pub struct ByteRange {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2221` | `pub struct TextElement {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2229` | `pub fn new(byte_range: ByteRange, placeholder: Option<String>) -> Self {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2236` | `pub fn set_placeholder(&mut self, placeholder: Option<String>) {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2240` | `pub fn placeholder(&self) -> Option<&str> {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2264` | `pub enum UserInput {` |
| `pub_fn` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2288` | `pub fn into_core(self) -> CoreUserInput {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2328` | `pub enum ThreadItem {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2437` | `pub enum WebSearchAction {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2511` | `pub enum CommandExecutionStatus {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2521` | `pub enum CollabAgentTool {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2532` | `pub struct FileUpdateChange {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2542` | `pub enum PatchChangeKind {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2551` | `pub enum PatchApplyStatus {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2561` | `pub enum McpToolCallStatus {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2570` | `pub enum CollabAgentToolCallStatus {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2579` | `pub enum CollabAgentStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2591` | `pub struct CollabAgentState {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2630` | `pub struct McpToolCallResult {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2643` | `pub struct McpToolCallError {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2652` | `pub struct ThreadStartedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2659` | `pub struct ThreadNameUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2669` | `pub struct TurnStartedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2677` | `pub struct Usage {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2686` | `pub struct TurnCompletedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2696` | `pub struct TurnDiffUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2705` | `pub struct TurnPlanUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2715` | `pub struct TurnPlanStep {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2723` | `pub enum TurnPlanStepStatus {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2751` | `pub struct ItemStartedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2760` | `pub struct ItemCompletedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2769` | `pub struct RawResponseItemCompletedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2779` | `pub struct AgentMessageDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2791` | `pub struct PlanDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2801` | `pub struct ReasoningSummaryTextDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2813` | `pub struct ReasoningSummaryPartAddedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2824` | `pub struct ReasoningTextDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2836` | `pub struct TerminalInteractionNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2847` | `pub struct CommandExecutionOutputDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2857` | `pub struct FileChangeOutputDeltaNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2867` | `pub struct McpToolCallProgressNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2877` | `pub struct McpServerOauthLoginCompletedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2888` | `pub struct WindowsWorldWritableWarningNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2898` | `pub struct ContextCompactedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2906` | `pub struct CommandExecutionRequestApprovalParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2933` | `pub struct CommandExecutionRequestApprovalResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2940` | `pub struct FileChangeRequestApprovalParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2955` | `pub struct FileChangeRequestApprovalResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2962` | `pub struct DynamicToolCallParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2973` | `pub struct DynamicToolCallResponse {` |
| `pub_enum` | `codex-rs/app-server-protocol/src/protocol/v2.rs:2982` | `pub enum DynamicToolCallOutputContentItem {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3006` | `pub struct ToolRequestUserInputOption {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3015` | `pub struct ToolRequestUserInputQuestion {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3030` | `pub struct ToolRequestUserInputParams {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3041` | `pub struct ToolRequestUserInputAnswer {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3049` | `pub struct ToolRequestUserInputResponse {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3056` | `pub struct AccountRateLimitsUpdatedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3063` | `pub struct RateLimitSnapshot {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3084` | `pub struct RateLimitWindow {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3105` | `pub struct CreditsSnapshot {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3124` | `pub struct AccountLoginCompletedNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3135` | `pub struct DeprecationNoticeNotification {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3145` | `pub struct TextPosition {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3155` | `pub struct TextRange {` |
| `pub_struct` | `codex-rs/app-server-protocol/src/protocol/v2.rs:3163` | `pub struct ConfigWarningNotification {` |
...
| `pub_fn` | `codex-rs/app-server-test-client/src/lib.rs:146` | `pub fn run() -> Result<()> {` |
| `pub_fn` | `codex-rs/app-server-test-client/src/lib.rs:220` | `pub fn send_message_v2(` |
| `fn_main` | `codex-rs/app-server-test-client/src/main.rs:3` | `fn main() -> Result<()> {` |
| `pub_fn` | `codex-rs/app-server/src/codex_message_processor.rs:350` | `pub fn new(args: CodexMessageProcessorArgs) -> Self {` |
| `pub_fn` | `codex-rs/app-server/src/codex_message_processor.rs:481` | `pub async fn process_request(&mut self, connection_id: ConnectionId, request: ClientRequest) {` |
| `pub_fn` | `codex-rs/app-server/src/lib.rs:174` | `pub async fn run_main(` |
| `pub_fn` | `codex-rs/app-server/src/lib.rs:190` | `pub async fn run_main_with_transport(` |
| `fn_main` | `codex-rs/app-server/src/main.rs:25` | `fn main() -> anyhow::Result<()> {` |
...
| `pub_enum` | `codex-rs/app-server/src/transport.rs:70` | `pub enum AppServerTransport {` |
| `pub_enum` | `codex-rs/app-server/src/transport.rs:76` | `pub enum AppServerTransportParseError {` |
| `pub_const` | `codex-rs/app-server/src/transport.rs:99` | `pub const DEFAULT_LISTEN_URL: &'static str = "stdio://";` |
| `pub_fn` | `codex-rs/app-server/src/transport.rs:101` | `pub fn from_listen_url(listen_url: &str) -> Result<Self, AppServerTransportParseError> {` |
...
| `pub_struct` | `codex-rs/app-server/tests/common/mcp_process.rs:69` | `pub struct McpProcess {` |
| `pub_const` | `codex-rs/app-server/tests/common/mcp_process.rs:81` | `pub const DEFAULT_CLIENT_NAME: &str = "codex-app-server-tests";` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:84` | `pub async fn new(codex_home: &Path) -> anyhow::Result<Self> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:93` | `pub async fn new_with_env(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:153` | `pub async fn initialize(&mut self) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:168` | `pub async fn initialize_with_client_info(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:181` | `pub async fn initialize_with_capabilities(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:236` | `pub async fn send_new_conversation_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:245` | `pub async fn send_archive_conversation_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:254` | `pub async fn send_add_conversation_listener_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:263` | `pub async fn send_send_user_message_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:273` | `pub async fn send_remove_thread_listener_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:283` | `pub async fn send_send_user_turn_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:292` | `pub async fn send_interrupt_conversation_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:301` | `pub async fn send_get_auth_status_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:310` | `pub async fn send_get_user_saved_config_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:315` | `pub async fn send_get_user_agent_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:320` | `pub async fn send_get_account_rate_limits_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:325` | `pub async fn send_get_account_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:334` | `pub async fn send_chatgpt_auth_tokens_login_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:348` | `pub async fn send_feedback_upload_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:357` | `pub async fn send_user_info_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:362` | `pub async fn send_set_default_model_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:371` | `pub async fn send_list_conversations_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:380` | `pub async fn send_thread_start_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:389` | `pub async fn send_thread_resume_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:398` | `pub async fn send_thread_fork_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:407` | `pub async fn send_thread_archive_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:416` | `pub async fn send_thread_unarchive_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:425` | `pub async fn send_thread_compact_start_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:434` | `pub async fn send_thread_rollback_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:443` | `pub async fn send_thread_list_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:452` | `pub async fn send_thread_loaded_list_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:461` | `pub async fn send_thread_read_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:470` | `pub async fn send_list_models_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:479` | `pub async fn send_experimental_feature_list_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:488` | `pub async fn send_apps_list_request(&mut self, params: AppsListParams) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:494` | `pub async fn send_list_collaboration_modes_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:503` | `pub async fn send_mock_experimental_method_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:512` | `pub async fn send_resume_conversation_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:521` | `pub async fn send_fork_conversation_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:530` | `pub async fn send_login_api_key_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:539` | `pub async fn send_login_chat_gpt_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:544` | `pub async fn send_turn_start_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:553` | `pub async fn send_turn_interrupt_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:562` | `pub async fn send_turn_steer_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:571` | `pub async fn send_review_start_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:580` | `pub async fn send_cancel_login_chat_gpt_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:589` | `pub async fn send_logout_chat_gpt_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:593` | `pub async fn send_config_read_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:601` | `pub async fn send_config_value_write_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:609` | `pub async fn send_config_batch_write_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:618` | `pub async fn send_logout_account_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:623` | `pub async fn send_login_account_api_key_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:635` | `pub async fn send_login_account_chatgpt_request(&mut self) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:643` | `pub async fn send_cancel_login_account_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:652` | `pub async fn send_fuzzy_file_search_request(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:684` | `pub async fn send_response(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:693` | `pub async fn send_error(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:702` | `pub async fn send_notification(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:735` | `pub async fn read_stream_until_request_message(&mut self) -> anyhow::Result<ServerRequest> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:750` | `pub async fn read_stream_until_response_message(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:768` | `pub async fn read_stream_until_error_message(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:784` | `pub async fn read_stream_until_notification_message(` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:805` | `pub async fn read_next_message(&mut self) -> anyhow::Result<JSONRPCMessage> {` |
| `pub_fn` | `codex-rs/app-server/tests/common/mcp_process.rs:813` | `pub fn clear_message_buffer(&mut self) {` |
...
| `pub_struct` | `codex-rs/arg0/src/lib.rs:17` | `pub struct Arg0PathEntryGuard {` |
| `pub_fn` | `codex-rs/arg0/src/lib.rs:31` | `pub fn arg0_dispatch() -> Option<Arg0PathEntryGuard> {` |
| `pub_fn` | `codex-rs/arg0/src/lib.rs:169` | `pub fn prepend_path_entry_for_codex_aliases() -> std::io::Result<Arg0PathEntryGuard> {` |
...
| `pub_fn` | `codex-rs/cli/src/debug_sandbox.rs:276` | `pub fn create_sandbox_mode(full_auto: bool) -> SandboxMode {` |
...
| `pub_fn` | `codex-rs/cli/src/login.rs:255` | `pub async fn run_logout(cli_config_overrides: CliConfigOverrides) -> ! {` |
| `fn_main` | `codex-rs/cli/src/main.rs:545` | `fn main() -> anyhow::Result<()> {` |
...
| `pub_fn` | `codex-rs/cloud-requirements/src/lib.rs:186` | `pub fn cloud_requirements_loader(` |
...
| `pub_trait` | `codex-rs/codex-api/src/auth.rs:10` | `pub trait AuthProvider: Send + Sync {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:19` | `pub struct Prompt {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:35` | `pub struct CompactionInput<'a> {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:43` | `pub struct MemoryTraceSummarizeInput {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:51` | `pub struct MemoryTrace {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:58` | `pub struct MemoryTraceMetadata {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:63` | `pub struct MemoryTraceSummaryOutput {` |
| `pub_enum` | `codex-rs/codex-api/src/common.rs:69` | `pub enum ResponseEvent {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:98` | `pub struct Reasoning {` |
| `pub_enum` | `codex-rs/codex-api/src/common.rs:107` | `pub enum TextFormatType {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:113` | `pub struct TextFormat {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:127` | `pub struct TextControls {` |
| `pub_enum` | `codex-rs/codex-api/src/common.rs:136` | `pub enum OpenAiVerbosity {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:154` | `pub struct ResponsesApiRequest<'a> {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:172` | `pub struct ResponseCreateWsRequest {` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:192` | `pub struct ResponseAppendWsRequest {` |
| `pub_enum` | `codex-rs/codex-api/src/common.rs:198` | `pub enum ResponsesWsRequest {` |
| `pub_fn` | `codex-rs/codex-api/src/common.rs:205` | `pub fn create_text_param_for_request(` |
| `pub_struct` | `codex-rs/codex-api/src/common.rs:224` | `pub struct ResponseStream {` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/aggregate.rs:14` | `pub struct AggregatedStream {` |
| `pub_trait` | `codex-rs/codex-api/src/endpoint/aggregate.rs:138` | `pub trait AggregateStreamExt {` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/compact.rs:15` | `pub struct CompactClient<T: HttpTransport, A: AuthProvider> {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/compact.rs:20` | `pub fn new(transport: T, provider: Provider, auth: A) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/compact.rs:26` | `pub fn with_telemetry(self, request: Option<Arc<dyn RequestTelemetry>>) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/compact.rs:36` | `pub async fn compact(` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/compact.rs:50` | `pub async fn compact_input(` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/memories.rs:15` | `pub struct MemoriesClient<T: HttpTransport, A: AuthProvider> {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/memories.rs:20` | `pub fn new(transport: T, provider: Provider, auth: A) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/memories.rs:26` | `pub fn with_telemetry(self, request: Option<Arc<dyn RequestTelemetry>>) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/memories.rs:36` | `pub async fn trace_summarize(` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/memories.rs:50` | `pub async fn trace_summarize_input(` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:1` | `pub mod aggregate;` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:2` | `pub mod compact;` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:3` | `pub mod memories;` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:4` | `pub mod models;` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:5` | `pub mod responses;` |
| `pub_mod` | `codex-rs/codex-api/src/endpoint/mod.rs:6` | `pub mod responses_websocket;` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/models.rs:14` | `pub struct ModelsClient<T: HttpTransport, A: AuthProvider> {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/models.rs:19` | `pub fn new(transport: T, provider: Provider, auth: A) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/models.rs:25` | `pub fn with_telemetry(self, request: Option<Arc<dyn RequestTelemetry>>) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/models.rs:40` | `pub async fn list_models(` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/responses.rs:26` | `pub struct ResponsesClient<T: HttpTransport, A: AuthProvider> {` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/responses.rs:32` | `pub struct ResponsesOptions {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses.rs:46` | `pub fn new(transport: T, provider: Provider, auth: A) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses.rs:53` | `pub fn with_telemetry(` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses.rs:64` | `pub async fn stream_request(` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses.rs:79` | `pub async fn stream_prompt(` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses.rs:119` | `pub async fn stream(` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:44` | `pub struct ResponsesWebsocketConnection {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:70` | `pub async fn is_closed(&self) -> bool {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:74` | `pub async fn stream_request(` |
| `pub_struct` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:127` | `pub struct ResponsesWebsocketClient<A: AuthProvider> {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:133` | `pub fn new(provider: Provider, auth: A) -> Self {` |
| `pub_fn` | `codex-rs/codex-api/src/endpoint/responses_websocket.rs:137` | `pub async fn connect(` |
...
| `pub_struct` | `codex-rs/codex-api/src/provider.rs:16` | `pub struct RetryConfig {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:25` | `pub fn to_policy(&self) -> RetryPolicy {` |
| `pub_struct` | `codex-rs/codex-api/src/provider.rs:43` | `pub struct Provider {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:53` | `pub fn url_for_path(&self, path: &str) -> String {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:77` | `pub fn build_request(&self, method: Method, path: &str) -> Request {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:88` | `pub fn is_azure_responses_endpoint(&self) -> bool {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:92` | `pub fn websocket_url_for_path(&self, path: &str) -> Result<Url, url::ParseError> {` |
| `pub_fn` | `codex-rs/codex-api/src/provider.rs:106` | `pub fn is_azure_responses_wire_base_url(name: &str, base_url: Option<&str>) -> bool {` |
| `pub_struct` | `codex-rs/codex-api/src/rate_limits.rs:10` | `pub struct RateLimitError {` |
| `pub_fn` | `codex-rs/codex-api/src/rate_limits.rs:21` | `pub fn parse_rate_limit(headers: &HeaderMap) -> Option<RateLimitSnapshot> {` |
| `pub_fn` | `codex-rs/codex-api/src/rate_limits.rs:75` | `pub fn parse_rate_limit_event(payload: &str) -> Option<RateLimitSnapshot> {` |
| `pub_fn` | `codex-rs/codex-api/src/rate_limits.rs:111` | `pub fn parse_promo_message(headers: &HeaderMap) -> Option<String> {` |
...
| `pub_mod` | `codex-rs/codex-api/src/requests/mod.rs:2` | `pub mod responses;` |
...
| `pub_mod` | `codex-rs/codex-api/src/sse/mod.rs:1` | `pub mod responses;` |
...
| `pub_fn` | `codex-rs/codex-api/src/sse/responses.rs:169` | `pub fn kind(&self) -> &str {` |
| `pub_enum` | `codex-rs/codex-api/src/sse/responses.rs:175` | `pub enum ResponsesEventError {` |
| `pub_fn` | `codex-rs/codex-api/src/sse/responses.rs:180` | `pub fn into_api_error(self) -> ApiError {` |
| `pub_fn` | `codex-rs/codex-api/src/sse/responses.rs:187` | `pub fn process_responses_event(` |
| `pub_fn` | `codex-rs/codex-api/src/sse/responses.rs:318` | `pub async fn process_sse(` |
...
| `pub_fn` | `codex-rs/common/src/oss.rs:8` | `pub fn get_default_model_for_oss_provider(provider_id: &str) -> Option<&'static str> {` |
| `pub_fn` | `codex-rs/common/src/oss.rs:17` | `pub async fn ensure_oss_provider_ready(` |
...
| `pub_enum` | `codex-rs/core/src/auth.rs:46` | `pub enum AuthMode {` |
| `pub_enum` | `codex-rs/core/src/auth.rs:62` | `pub enum CodexAuth {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:69` | `pub struct ApiKeyAuth {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:74` | `pub struct ChatgptAuth {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:80` | `pub struct ChatgptAuthTokens {` |
| `pub_const` | `codex-rs/core/src/auth.rs:105` | `pub const REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR: &str = "CODEX_REFRESH_TOKEN_URL_OVERRIDE";` |
| `pub_enum` | `codex-rs/core/src/auth.rs:108` | `pub enum RefreshTokenError {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:116` | `pub struct ExternalAuthTokens {` |
| `pub_enum` | `codex-rs/core/src/auth.rs:122` | `pub enum ExternalAuthRefreshReason {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:127` | `pub struct ExternalAuthRefreshContext {` |
| `pub_trait` | `codex-rs/core/src/auth.rs:133` | `pub trait ExternalAuthRefresher: Send + Sync {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:141` | `pub fn failed_reason(&self) -> Option<RefreshTokenFailedReason> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:192` | `pub fn from_auth_storage(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:199` | `pub fn auth_mode(&self) -> AuthMode {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:206` | `pub fn api_auth_mode(&self) -> ApiAuthMode {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:214` | `pub fn is_chatgpt_auth(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:218` | `pub fn is_external_chatgpt_tokens(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:223` | `pub fn api_key(&self) -> Option<&str> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:231` | `pub fn get_token_data(&self) -> Result<TokenData, std::io::Error> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:244` | `pub fn get_token(&self) -> Result<String, std::io::Error> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:255` | `pub fn get_account_id(&self) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:260` | `pub fn get_account_email(&self) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:268` | `pub fn account_plan_type(&self) -> Option<AccountPlanType> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:305` | `pub fn create_dummy_chatgpt_auth_for_testing() -> Self {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:333` | `pub fn from_api_key(api_key: &str) -> Self {` |
| `pub_const` | `codex-rs/core/src/auth.rs:357` | `pub const OPENAI_API_KEY_ENV_VAR: &str = "OPENAI_API_KEY";` |
| `pub_const` | `codex-rs/core/src/auth.rs:358` | `pub const CODEX_API_KEY_ENV_VAR: &str = "CODEX_API_KEY";` |
| `pub_fn` | `codex-rs/core/src/auth.rs:360` | `pub fn read_openai_api_key_from_env() -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:367` | `pub fn read_codex_api_key_from_env() -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:376` | `pub fn logout(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:385` | `pub fn login_with_api_key(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:400` | `pub fn login_with_chatgpt_auth_tokens(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:414` | `pub fn save_auth(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:428` | `pub fn load_auth_dot_json(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:436` | `pub fn enforce_login_restrictions(config: &Config) -> std::io::Result<()> {` |
| `pub_const` | `codex-rs/core/src/auth.rs:722` | `pub const CLIENT_ID: &str = "app_EMoamEEZ73f0CkXaXp7hrann";` |
| `pub_struct` | `codex-rs/core/src/auth.rs:832` | `pub struct UnauthorizedRecovery {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:863` | `pub fn has_next(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:882` | `pub async fn next(&mut self) -> Result<(), RefreshTokenError> {` |
| `pub_struct` | `codex-rs/core/src/auth.rs:930` | `pub struct AuthManager {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:943` | `pub fn new(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:969` | `pub fn from_auth_for_testing(auth: CodexAuth) -> Arc<Self> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:986` | `pub fn from_auth_for_testing_with_home(auth: CodexAuth, codex_home: PathBuf) -> Arc<Self> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1001` | `pub fn auth_cached(&self) -> Option<CodexAuth> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1007` | `pub async fn auth(&self) -> Option<CodexAuth> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1018` | `pub fn reload(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1079` | `pub fn set_external_auth_refresher(&self, refresher: Arc<dyn ExternalAuthRefresher>) {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1085` | `pub fn set_forced_chatgpt_workspace_id(&self, workspace_id: Option<String>) {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1091` | `pub fn forced_chatgpt_workspace_id(&self) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1098` | `pub fn has_external_auth_refresher(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1106` | `pub fn is_external_auth_active(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1113` | `pub fn shared(` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1125` | `pub fn unauthorized_recovery(self: &Arc<Self>) -> UnauthorizedRecovery {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1132` | `pub async fn refresh_token(&self) -> Result<(), RefreshTokenError> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1164` | `pub fn logout(&self) -> std::io::Result<bool> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1171` | `pub fn get_api_auth_mode(&self) -> Option<ApiAuthMode> {` |
| `pub_fn` | `codex-rs/core/src/auth.rs:1175` | `pub fn auth_mode(&self) -> Option<AuthMode> {` |
...
| `pub_const` | `codex-rs/core/src/client.rs:105` | `pub const OPENAI_BETA_HEADER: &str = "OpenAI-Beta";` |
| `pub_const` | `codex-rs/core/src/client.rs:106` | `pub const OPENAI_BETA_RESPONSES_WEBSOCKETS: &str = "responses_websockets=2026-02-04";` |
| `pub_const` | `codex-rs/core/src/client.rs:107` | `pub const X_CODEX_TURN_STATE_HEADER: &str = "x-codex-turn-state";` |
| `pub_const` | `codex-rs/core/src/client.rs:108` | `pub const X_CODEX_TURN_METADATA_HEADER: &str = "x-codex-turn-metadata";` |
| `pub_const` | `codex-rs/core/src/client.rs:109` | `pub const X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER: &str =` |
| `pub_struct` | `codex-rs/core/src/client.rs:189` | `pub struct ModelClient {` |
| `pub_struct` | `codex-rs/core/src/client.rs:209` | `pub struct ModelClientSession {` |
| `pub_fn` | `codex-rs/core/src/client.rs:239` | `pub fn new(` |
| `pub_fn` | `codex-rs/core/src/client.rs:274` | `pub fn new_session(&self) -> ModelClientSession {` |
| `pub_fn` | `codex-rs/core/src/client.rs:291` | `pub fn pre_establish_connection(` |
| `pub_fn` | `codex-rs/core/src/client.rs:365` | `pub async fn compact_conversation_history(` |
| `pub_fn` | `codex-rs/core/src/client.rs:401` | `pub async fn summarize_memory_traces(` |
| `pub_fn` | `codex-rs/core/src/client.rs:1036` | `pub async fn stream(` |
| `pub_const` | `codex-rs/core/src/client_common.rs:18` | `pub const REVIEW_PROMPT: &str = include_str!("../review_prompt.md");` |
| `pub_const` | `codex-rs/core/src/client_common.rs:21` | `pub const REVIEW_EXIT_SUCCESS_TMPL: &str = include_str!("../templates/review/exit_success.xml");` |
| `pub_const` | `codex-rs/core/src/client_common.rs:22` | `pub const REVIEW_EXIT_INTERRUPTED_TMPL: &str =` |
| `pub_struct` | `codex-rs/core/src/client_common.rs:27` | `pub struct Prompt {` |
| `pub_struct` | `codex-rs/core/src/client_common.rs:200` | `pub struct FreeformTool {` |
| `pub_struct` | `codex-rs/core/src/client_common.rs:207` | `pub struct FreeformToolFormat {` |
| `pub_struct` | `codex-rs/core/src/client_common.rs:214` | `pub struct ResponsesApiTool {` |
| `pub_struct` | `codex-rs/core/src/client_common.rs:225` | `pub struct ResponseStream {` |
| `pub_enum` | `codex-rs/core/src/codex.rs:124` | `pub enum SteerInputError {` |
| `pub_struct` | `codex-rs/core/src/codex.rs:237` | `pub struct Codex {` |
| `pub_struct` | `codex-rs/core/src/codex.rs:249` | `pub struct CodexSpawnOk {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:437` | `pub async fn submit(&self, op: Op) -> CodexResult<String> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:449` | `pub async fn submit_with_id(&self, sub: Submission) -> CodexResult<()> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:457` | `pub async fn next_event(&self) -> CodexResult<Event> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:466` | `pub async fn steer_input(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:571` | `pub async fn resolve_turn_metadata_header(&self) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:583` | `pub fn spawn_turn_metadata_header_task(self: &Arc<Self>) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1824` | `pub async fn request_command_approval(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1865` | `pub async fn request_patch_approval(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1902` | `pub async fn request_user_input(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1934` | `pub async fn notify_user_input_response(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1959` | `pub async fn notify_dynamic_tool_response(&self, call_id: &str, response: DynamicToolResponse) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:1980` | `pub async fn notify_approval(&self, sub_id: &str, decision: ReviewDecision) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2001` | `pub async fn resolve_elicitation(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2128` | `pub fn enabled(&self, feature: Feature) -> bool {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2304` | `pub async fn dependency_env(&self) -> HashMap<String, String> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2309` | `pub async fn set_dependency_env(&self, values: HashMap<String, String>) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2429` | `pub async fn steer_input(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2462` | `pub async fn inject_response_items(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2479` | `pub async fn get_pending_input(&self) -> Vec<ResponseInputItem> {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2490` | `pub async fn has_pending_input(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2501` | `pub async fn list_resources(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2514` | `pub async fn list_resource_templates(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2527` | `pub async fn read_resource(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2540` | `pub async fn call_tool(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2563` | `pub async fn interrupt_task(self: &Arc<Self>) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2889` | `pub async fn interrupt(sess: &Arc<Session>) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2893` | `pub async fn override_turn_context(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2910` | `pub async fn user_input_or_turn(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:2994` | `pub async fn run_user_shell_command(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3027` | `pub async fn resolve_elicitation(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3064` | `pub async fn exec_approval(sess: &Arc<Session>, id: String, decision: ReviewDecision) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3097` | `pub async fn patch_approval(sess: &Arc<Session>, id: String, decision: ReviewDecision) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3106` | `pub async fn request_user_input_response(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3114` | `pub async fn dynamic_tool_response(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3122` | `pub async fn add_to_history(sess: &Arc<Session>, config: &Arc<Config>, text: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3132` | `pub async fn get_history_entry_request(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3169` | `pub async fn refresh_mcp_servers(sess: &Arc<Session>, refresh_config: McpServerRefreshConfig) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3174` | `pub async fn list_mcp_tools(sess: &Session, config: &Arc<Config>, sub_id: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3191` | `pub async fn list_custom_prompts(sess: &Session, sub_id: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3208` | `pub async fn list_skills(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3241` | `pub async fn list_remote_skills(sess: &Session, config: &Arc<Config>, sub_id: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3278` | `pub async fn download_remote_skill(` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3312` | `pub async fn undo(sess: &Arc<Session>, sub_id: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3318` | `pub async fn compact(sess: &Arc<Session>, sub_id: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3333` | `pub async fn thread_rollback(sess: &Arc<Session>, sub_id: String, num_turns: u32) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3383` | `pub async fn set_thread_name(sess: &Arc<Session>, sub_id: String, name: String) {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3442` | `pub async fn shutdown(sess: &Arc<Session>, sub_id: String) -> bool {` |
| `pub_fn` | `codex-rs/core/src/codex.rs:3489` | `pub async fn review(` |
| `pub_struct` | `codex-rs/core/src/codex_thread.rs:20` | `pub struct ThreadConfigSnapshot {` |
| `pub_struct` | `codex-rs/core/src/codex_thread.rs:31` | `pub struct CodexThread {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:46` | `pub async fn submit(&self, op: Op) -> CodexResult<String> {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:50` | `pub async fn steer_input(` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:59` | `pub async fn submit_with_id(&self, sub: Submission) -> CodexResult<()> {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:63` | `pub async fn next_event(&self) -> CodexResult<Event> {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:67` | `pub async fn agent_status(&self) -> AgentStatus {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:75` | `pub fn rollout_path(&self) -> Option<PathBuf> {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:79` | `pub fn state_db(&self) -> Option<StateDbHandle> {` |
| `pub_fn` | `codex-rs/core/src/codex_thread.rs:83` | `pub async fn config_snapshot(&self) -> ThreadConfigSnapshot {` |
...
| `pub_const` | `codex-rs/core/src/compact.rs:31` | `pub const SUMMARIZATION_PROMPT: &str = include_str!("../templates/compact/prompt.md");` |
| `pub_const` | `codex-rs/core/src/compact.rs:32` | `pub const SUMMARY_PREFIX: &str = include_str!("../templates/compact/summary_prefix.md");` |
| `pub_fn` | `codex-rs/core/src/compact.rs:217` | `pub fn content_items_to_text(content: &[ContentItem]) -> Option<String> {` |
...
| `pub_fn` | `codex-rs/core/src/config/edit.rs:58` | `pub fn status_line_items_edit(items: &[String]) -> ConfigEdit {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:652` | `pub fn apply_blocking(` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:706` | `pub async fn apply(` |
| `pub_struct` | `codex-rs/core/src/config/edit.rs:720` | `pub struct ConfigEditsBuilder {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:727` | `pub fn new(codex_home: &Path) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:735` | `pub fn with_profile(mut self, profile: Option<&str>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:740` | `pub fn set_model(mut self, model: Option<&str>, effort: Option<ReasoningEffort>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:748` | `pub fn set_personality(mut self, personality: Option<Personality>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:754` | `pub fn set_hide_full_access_warning(mut self, acknowledged: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:760` | `pub fn set_hide_world_writable_warning(mut self, acknowledged: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:766` | `pub fn set_hide_rate_limit_model_nudge(mut self, acknowledged: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:772` | `pub fn set_hide_model_migration_prompt(mut self, model: &str, acknowledged: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:781` | `pub fn record_model_migration_seen(mut self, from: &str, to: &str) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:789` | `pub fn set_windows_wsl_setup_acknowledged(mut self, acknowledged: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:795` | `pub fn replace_mcp_servers(mut self, servers: &BTreeMap<String, McpServerConfig>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:814` | `pub fn set_feature_enabled(mut self, key: &str, enabled: bool) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:831` | `pub fn apply_blocking(self) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/core/src/config/edit.rs:836` | `pub async fn apply(self) -> anyhow::Result<()> {` |
| `pub_mod` | `codex-rs/core/src/config/mod.rs:81` | `pub mod edit;` |
| `pub_mod` | `codex-rs/core/src/config/mod.rs:82` | `pub mod profile;` |
| `pub_mod` | `codex-rs/core/src/config/mod.rs:83` | `pub mod schema;` |
| `pub_mod` | `codex-rs/core/src/config/mod.rs:84` | `pub mod service;` |
| `pub_mod` | `codex-rs/core/src/config/mod.rs:85` | `pub mod types;` |
| `pub_const` | `codex-rs/core/src/config/mod.rs:101` | `pub const CONFIG_TOML_FILE: &str = "config.toml";` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:116` | `pub struct Config {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:382` | `pub struct ConfigBuilder {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:392` | `pub fn codex_home(mut self, codex_home: PathBuf) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:397` | `pub fn cli_overrides(mut self, cli_overrides: Vec<(String, TomlValue)>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:402` | `pub fn harness_overrides(mut self, harness_overrides: ConfigOverrides) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:407` | `pub fn loader_overrides(mut self, loader_overrides: LoaderOverrides) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:412` | `pub fn cloud_requirements(mut self, cloud_requirements: CloudRequirementsLoader) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:417` | `pub fn fallback_cwd(mut self, fallback_cwd: Option<PathBuf>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:422` | `pub async fn build(self) -> std::io::Result<Config> {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:481` | `pub async fn load_with_cli_overrides(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:491` | `pub fn load_default_with_cli_overrides(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:519` | `pub async fn load_with_cli_overrides_and_harness_overrides(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:534` | `pub async fn load_config_as_toml_with_cli_overrides(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:664` | `pub async fn load_global_mcp_servers(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:791` | `pub fn set_project_trust_level(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:804` | `pub fn set_default_oss_provider(codex_home: &Path, provider: &str) -> std::io::Result<()> {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:841` | `pub struct ConfigToml {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1080` | `pub struct ProjectConfig {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1085` | `pub fn is_trusted(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1089` | `pub fn is_untrusted(&self) -> bool {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1096` | `pub struct ToolsToml {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1107` | `pub struct AgentsToml {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1125` | `pub struct GhostSnapshotToml {` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1138` | `pub struct SandboxPolicyResolution {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1222` | `pub fn get_active_project(&self, resolved_cwd: &Path) -> Option<ProjectConfig> {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1242` | `pub fn get_config_profile(` |
| `pub_struct` | `codex-rs/core/src/config/mod.rs:1266` | `pub struct ConfigOverrides {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1289` | `pub fn resolve_oss_provider(` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1862` | `pub fn set_windows_sandbox_enabled(&mut self, value: bool) {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1871` | `pub fn set_windows_elevated_sandbox_enabled(&mut self, value: bool) {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1913` | `pub fn find_codex_home() -> std::io::Result<PathBuf> {` |
| `pub_fn` | `codex-rs/core/src/config/mod.rs:1919` | `pub fn log_dir(cfg: &Config) -> std::io::Result<PathBuf> {` |
...
| `pub_enum` | `codex-rs/core/src/config/types.rs:217` | `pub enum McpServerTransportConfig {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:274` | `pub enum UriBasedFileOpener {` |
| `pub_fn` | `codex-rs/core/src/config/types.rs:293` | `pub fn get_scheme(&self) -> Option<&str> {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:307` | `pub struct History {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:318` | `pub enum HistoryPersistence {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:331` | `pub struct AnalyticsConfigToml {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:338` | `pub struct FeedbackConfigToml {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:345` | `pub enum AppDisabledReason {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:362` | `pub struct AppConfig {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:375` | `pub struct AppsConfigToml {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:385` | `pub enum OtelHttpProtocol {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:395` | `pub struct OtelTlsConfig {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:405` | `pub enum OtelExporterKind {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:428` | `pub struct OtelConfigToml {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:444` | `pub struct OtelConfig {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:466` | `pub enum Notifications {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:479` | `pub enum NotificationMethod {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:499` | `pub struct Tui {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:551` | `pub struct Notice {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:575` | `pub struct SkillConfig {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:582` | `pub struct SkillsConfig {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:589` | `pub struct SandboxWorkspaceWrite {` |
| `pub_enum` | `codex-rs/core/src/config/types.rs:613` | `pub enum ShellEnvironmentPolicyInherit {` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:630` | `pub struct ShellEnvironmentPolicyToml {` |
| `pub_type` | `codex-rs/core/src/config/types.rs:646` | `pub type EnvironmentVariablePattern = WildMatchPattern<'*', '?'>;` |
| `pub_struct` | `codex-rs/core/src/config/types.rs:656` | `pub struct ShellEnvironmentPolicy {` |
...
| `pub_enum` | `codex-rs/core/src/config_loader/config_requirements.rs:16` | `pub enum RequirementSource {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:49` | `pub struct ConstrainedWithSource<T> {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:55` | `pub fn new(value: Constrained<T>, source: Option<RequirementSource>) -> Self {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:77` | `pub struct ConfigRequirements {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:112` | `pub fn exec_policy_source(&self) -> Option<&RequirementSource> {` |
| `pub_enum` | `codex-rs/core/src/config_loader/config_requirements.rs:119` | `pub enum McpServerIdentity {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:125` | `pub struct McpServerRequirement {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:130` | `pub struct NetworkRequirementsToml {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:145` | `pub struct NetworkConstraints {` |
| `pub_enum` | `codex-rs/core/src/config_loader/config_requirements.rs:189` | `pub enum WebSearchModeRequirement {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:227` | `pub struct ConfigRequirementsToml {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:241` | `pub struct Sourced<T> {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:247` | `pub fn new(value: T, source: RequirementSource) -> Self {` |
| `pub_struct` | `codex-rs/core/src/config_loader/config_requirements.rs:261` | `pub struct ConfigRequirementsWithSources {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:272` | `pub fn merge_unset_fields(&mut self, source: RequirementSource, other: ConfigRequirementsToml) {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:308` | `pub fn into_toml(self) -> ConfigRequirementsToml {` |
| `pub_enum` | `codex-rs/core/src/config_loader/config_requirements.rs:333` | `pub enum SandboxModeRequirement {` |
| `pub_enum` | `codex-rs/core/src/config_loader/config_requirements.rs:359` | `pub enum ResidencyRequirement {` |
| `pub_fn` | `codex-rs/core/src/config_loader/config_requirements.rs:364` | `pub fn is_empty(&self) -> bool {` |
...
| `pub_const` | `codex-rs/core/src/config_loader/mod.rs:70` | `pub const SYSTEM_CONFIG_TOML_FILE_UNIX: &str = "/etc/codex/config.toml";` |
| `pub_fn` | `codex-rs/core/src/config_loader/mod.rs:104` | `pub async fn load_config_layers_state(` |
...
| `pub_fn` | `codex-rs/core/src/connectors.rs:81` | `pub fn connector_display_label(connector: &AppInfo) -> String {` |
| `pub_fn` | `codex-rs/core/src/connectors.rs:85` | `pub fn connector_mention_slug(connector: &AppInfo) -> String {` |
| `pub_fn` | `codex-rs/core/src/connectors.rs:103` | `pub fn merge_connectors(` |
| `pub_fn` | `codex-rs/core/src/connectors.rs:201` | `pub fn connector_install_url(name: &str, connector_id: &str) -> String {` |
| `pub_fn` | `codex-rs/core/src/connectors.rs:206` | `pub fn connector_name_slug(name: &str) -> String {` |
...
| `pub_struct` | `codex-rs/core/src/error.rs:389` | `pub struct RetryLimitReachedError {` |
| `pub_struct` | `codex-rs/core/src/error.rs:409` | `pub struct UsageLimitReachedError {` |
| `pub_struct` | `codex-rs/core/src/error.rs:463` | `pub struct ModelCapError {` |
| `pub_struct` | `codex-rs/core/src/error.rs:558` | `pub struct EnvVarError {` |
| `pub_fn` | `codex-rs/core/src/error.rs:586` | `pub fn to_codex_protocol_error(&self) -> CodexErrorInfo {` |
| `pub_fn` | `codex-rs/core/src/error.rs:617` | `pub fn to_error_event(&self, message_prefix: Option<String>) -> ErrorEvent {` |
| `pub_fn` | `codex-rs/core/src/error.rs:629` | `pub fn http_status_code_value(&self) -> Option<u16> {` |
| `pub_fn` | `codex-rs/core/src/error.rs:641` | `pub fn get_error_message_ui(e: &CodexErr) -> String {` |
| `pub_fn` | `codex-rs/core/src/event_mapping.rs:96` | `pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {` |
...
| `pub_struct` | `codex-rs/core/src/exec.rs:143` | `pub struct StdoutStream {` |
| `pub_fn` | `codex-rs/core/src/exec.rs:149` | `pub async fn process_exec_tool_call(` |
| `pub_struct` | `codex-rs/core/src/exec.rs:563` | `pub struct StreamOutput<T: Clone> {` |
| `pub_fn` | `codex-rs/core/src/exec.rs:578` | `pub fn new(text: String) -> Self {` |
| `pub_fn` | `codex-rs/core/src/exec.rs:587` | `pub fn from_utf8_lossy(&self) -> StreamOutput<String> {` |
| `pub_struct` | `codex-rs/core/src/exec.rs:639` | `pub struct ExecToolCallOutput {` |
| `pub_const` | `codex-rs/core/src/exec_env.rs:8` | `pub const CODEX_THREAD_ID_ENV_VAR: &str = "CODEX_THREAD_ID";` |
| `pub_fn` | `codex-rs/core/src/exec_env.rs:20` | `pub fn create_env(` |
| `pub_enum` | `codex-rs/core/src/exec_policy.rs:46` | `pub enum ExecPolicyError {` |
| `pub_enum` | `codex-rs/core/src/exec_policy.rs:67` | `pub enum ExecPolicyUpdateError {` |
| `pub_fn` | `codex-rs/core/src/exec_policy.rs:203` | `pub async fn check_execpolicy_for_warnings(` |
| `pub_fn` | `codex-rs/core/src/exec_policy.rs:220` | `pub async fn load_exec_policy(config_stack: &ConfigLayerStack) -> Result<Policy, ExecPolicyError> {` |
| `pub_fn` | `codex-rs/core/src/exec_policy.rs:270` | `pub fn render_decision_for_unmatched_command(` |
...
| `pub_fn` | `codex-rs/core/src/features.rs:135` | `pub fn key(self) -> &'static str {` |
| `pub_fn` | `codex-rs/core/src/features.rs:139` | `pub fn stage(self) -> Stage {` |
| `pub_fn` | `codex-rs/core/src/features.rs:143` | `pub fn default_enabled(self) -> bool {` |
| `pub_struct` | `codex-rs/core/src/features.rs:156` | `pub struct LegacyFeatureUsage {` |
| `pub_struct` | `codex-rs/core/src/features.rs:165` | `pub struct Features {` |
| `pub_struct` | `codex-rs/core/src/features.rs:171` | `pub struct FeatureOverrides {` |
| `pub_fn` | `codex-rs/core/src/features.rs:189` | `pub fn with_defaults() -> Self {` |
| `pub_fn` | `codex-rs/core/src/features.rs:202` | `pub fn enabled(&self, f: Feature) -> bool {` |
| `pub_fn` | `codex-rs/core/src/features.rs:206` | `pub fn enable(&mut self, f: Feature) -> &mut Self {` |
| `pub_fn` | `codex-rs/core/src/features.rs:211` | `pub fn disable(&mut self, f: Feature) -> &mut Self {` |
| `pub_fn` | `codex-rs/core/src/features.rs:216` | `pub fn record_legacy_usage_force(&mut self, alias: &str, feature: Feature) {` |
| `pub_fn` | `codex-rs/core/src/features.rs:226` | `pub fn record_legacy_usage(&mut self, alias: &str, feature: Feature) {` |
| `pub_fn` | `codex-rs/core/src/features.rs:233` | `pub fn legacy_feature_usages(&self) -> impl Iterator<Item = &LegacyFeatureUsage> + '_ {` |
| `pub_fn` | `codex-rs/core/src/features.rs:237` | `pub fn emit_metrics(&self, otel: &OtelManager) {` |
| `pub_fn` | `codex-rs/core/src/features.rs:253` | `pub fn apply_map(&mut self, m: &BTreeMap<String, bool>) {` |
| `pub_fn` | `codex-rs/core/src/features.rs:288` | `pub fn from_config(` |
| `pub_fn` | `codex-rs/core/src/features.rs:325` | `pub fn enabled_features(&self) -> Vec<Feature> {` |
| `pub_fn` | `codex-rs/core/src/features.rs:377` | `pub fn is_known_feature_key(key: &str) -> bool {` |
| `pub_struct` | `codex-rs/core/src/features.rs:383` | `pub struct FeaturesToml {` |
| `pub_struct` | `codex-rs/core/src/features.rs:390` | `pub struct FeatureSpec {` |
| `pub_const` | `codex-rs/core/src/features.rs:397` | `pub const FEATURES: &[FeatureSpec] = &[` |
...
| `pub_enum` | `codex-rs/core/src/file_watcher.rs:29` | `pub enum FileWatcherEvent {` |
...
| `pub_mod` | `codex-rs/core/src/lib.rs:24` | `pub mod config;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:25` | `pub mod config_loader;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:26` | `pub mod connectors;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:28` | `pub mod custom_prompts;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:29` | `pub mod env;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:31` | `pub mod error;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:32` | `pub mod exec;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:33` | `pub mod exec_env;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:35` | `pub mod features;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:38` | `pub mod git_info;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:39` | `pub mod hooks;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:40` | `pub mod instructions;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:41` | `pub mod landlock;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:42` | `pub mod mcp;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:44` | `pub mod models_manager;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:52` | `pub mod parse_command;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:53` | `pub mod path_utils;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:54` | `pub mod personality_migration;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:55` | `pub mod powershell;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:57` | `pub mod sandboxing;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:62` | `pub mod token_data;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:65` | `pub mod windows_sandbox;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:76` | `pub mod review_format;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:77` | `pub mod review_prompts;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:79` | `pub mod web_search;` |
| `pub_type` | `codex-rs/core/src/lib.rs:84` | `pub type ConversationManager = ThreadManager;` |
| `pub_type` | `codex-rs/core/src/lib.rs:86` | `pub type NewConversation = NewThread;` |
| `pub_type` | `codex-rs/core/src/lib.rs:88` | `pub type CodexConversation = CodexThread;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:92` | `pub mod default_client;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:93` | `pub mod project_doc;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:96` | `pub mod seatbelt;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:97` | `pub mod shell;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:98` | `pub mod shell_snapshot;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:99` | `pub mod skills;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:100` | `pub mod spawn;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:101` | `pub mod state_db;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:102` | `pub mod terminal;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:104` | `pub mod turn_diff_tracker;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:131` | `pub mod util;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:164` | `pub mod compact;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:165` | `pub mod memory_trace;` |
| `pub_mod` | `codex-rs/core/src/lib.rs:166` | `pub mod otel_init;` |
...
| `pub_fn` | `codex-rs/core/src/mcp/mod.rs:141` | `pub async fn collect_mcp_snapshot(config: &Config) -> McpListToolsResponseEvent {` |
| `pub_fn` | `codex-rs/core/src/mcp/mod.rs:193` | `pub fn split_qualified_tool_name(qualified_name: &str) -> Option<(String, String)> {` |
| `pub_fn` | `codex-rs/core/src/mcp/mod.rs:207` | `pub fn group_tools_by_server(` |
| `pub_const` | `codex-rs/core/src/mcp_connection_manager.rs:84` | `pub const DEFAULT_STARTUP_TIMEOUT: Duration = Duration::from_secs(10);` |
| `pub_const` | `codex-rs/core/src/mcp_connection_manager.rs:318` | `pub const MCP_SANDBOX_STATE_CAPABILITY: &str = "codex/sandbox-state";` |
| `pub_const` | `codex-rs/core/src/mcp_connection_manager.rs:322` | `pub const MCP_SANDBOX_STATE_METHOD: &str = "codex/sandbox-state/update";` |
| `pub_struct` | `codex-rs/core/src/mcp_connection_manager.rs:326` | `pub struct SandboxState {` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:342` | `pub async fn initialize(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:455` | `pub async fn resolve_elicitation(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:505` | `pub async fn list_all_tools(&self) -> HashMap<String, ToolInfo> {` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:536` | `pub async fn list_all_resources(&self) -> HashMap<String, Vec<Resource>> {` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:601` | `pub async fn list_all_resource_templates(&self) -> HashMap<String, Vec<ResourceTemplate>> {` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:669` | `pub async fn call_tool(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:706` | `pub async fn list_resources(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:722` | `pub async fn list_resource_templates(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:738` | `pub async fn read_resource(` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:754` | `pub async fn parse_tool_name(&self, tool_name: &str) -> Option<(String, String)> {` |
| `pub_fn` | `codex-rs/core/src/mcp_connection_manager.rs:761` | `pub async fn notify_sandbox_state_change(&self, sandbox_state: &SandboxState) -> Result<()> {` |
| `pub_struct` | `codex-rs/core/src/memory_trace.rs:16` | `pub struct BuiltTraceMemory {` |
| `pub_fn` | `codex-rs/core/src/memory_trace.rs:36` | `pub async fn build_memories_from_trace_files(` |
| `pub_struct` | `codex-rs/core/src/message_history.rs:57` | `pub struct HistoryEntry {` |
| `pub_enum` | `codex-rs/core/src/model_provider_info.rs:38` | `pub enum WireApi {` |
| `pub_struct` | `codex-rs/core/src/model_provider_info.rs:61` | `pub struct ModelProviderInfo {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:179` | `pub fn api_key(&self) -> crate::error::Result<Option<String>> {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:203` | `pub fn request_max_retries(&self) -> u64 {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:210` | `pub fn stream_max_retries(&self) -> u64 {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:217` | `pub fn stream_idle_timeout(&self) -> Duration {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:222` | `pub fn create_openai_provider() -> ModelProviderInfo {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:263` | `pub fn is_openai(&self) -> bool {` |
| `pub_const` | `codex-rs/core/src/model_provider_info.rs:268` | `pub const DEFAULT_LMSTUDIO_PORT: u16 = 1234;` |
| `pub_const` | `codex-rs/core/src/model_provider_info.rs:269` | `pub const DEFAULT_OLLAMA_PORT: u16 = 11434;` |
| `pub_const` | `codex-rs/core/src/model_provider_info.rs:271` | `pub const LMSTUDIO_OSS_PROVIDER_ID: &str = "lmstudio";` |
| `pub_const` | `codex-rs/core/src/model_provider_info.rs:272` | `pub const OLLAMA_OSS_PROVIDER_ID: &str = "ollama";` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:275` | `pub fn built_in_model_providers() -> HashMap<String, ModelProviderInfo> {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:298` | `pub fn create_oss_provider(default_provider_port: u16, wire_api: WireApi) -> ModelProviderInfo {` |
| `pub_fn` | `codex-rs/core/src/model_provider_info.rs:318` | `pub fn create_oss_provider_with_base_url(base_url: &str, wire_api: WireApi) -> ModelProviderInfo {` |
| `pub_fn` | `codex-rs/core/src/models_manager/collaboration_mode_presets.rs:17` | `pub fn test_builtin_collaboration_mode_presets() -> Vec<CollaborationModeMask> {` |
...
| `pub_fn` | `codex-rs/core/src/models_manager/manager.rs:314` | `pub fn with_provider(` |
| `pub_fn` | `codex-rs/core/src/models_manager/manager.rs:333` | `pub fn get_model_offline(model: Option<&str>) -> String {` |
| `pub_fn` | `codex-rs/core/src/models_manager/manager.rs:348` | `pub fn construct_model_info_offline(model: &str, config: &Config) -> ModelInfo {` |
...
| `pub_struct` | `codex-rs/core/src/rollout/list.rs:30` | `pub struct ThreadsPage {` |
| `pub_struct` | `codex-rs/core/src/rollout/list.rs:43` | `pub struct ThreadItem {` |
| `pub_type` | `codex-rs/core/src/rollout/list.rs:74` | `pub type ConversationItem = ThreadItem;` |
| `pub_type` | `codex-rs/core/src/rollout/list.rs:77` | `pub type ConversationsPage = ThreadsPage;` |
| `pub_enum` | `codex-rs/core/src/rollout/list.rs:102` | `pub enum ThreadSortKey {` |
| `pub_struct` | `codex-rs/core/src/rollout/list.rs:122` | `pub struct Cursor {` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:653` | `pub fn parse_cursor(token: &str) -> Option<Cursor> {` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:1073` | `pub async fn read_head_for_summary(path: &Path) -> io::Result<Vec<serde_json::Value>> {` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:1120` | `pub async fn read_session_meta_line(path: &Path) -> io::Result<SessionMetaLine> {` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:1232` | `pub async fn find_thread_path_by_id_str(` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:1240` | `pub async fn find_archived_thread_path_by_id_str(` |
| `pub_fn` | `codex-rs/core/src/rollout/list.rs:1248` | `pub fn rollout_date_parts(file_name: &OsStr) -> Option<(String, String, String)> {` |
...
| `pub_mod` | `codex-rs/core/src/rollout/mod.rs:31` | `pub mod tests;` |
| `pub_struct` | `codex-rs/core/src/rollout/recorder.rs:63` | `pub struct RolloutRecorder {` |
| `pub_enum` | `codex-rs/core/src/rollout/recorder.rs:70` | `pub enum RolloutRecorderParams {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:98` | `pub fn new(` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:114` | `pub fn resume(path: PathBuf) -> Self {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:121` | `pub async fn list_threads(` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:144` | `pub async fn list_archived_threads(` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:226` | `pub async fn find_latest_thread_path(` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:292` | `pub async fn new(` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:381` | `pub fn rollout_path(&self) -> &Path {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:385` | `pub fn state_db(&self) -> Option<StateDbHandle> {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:411` | `pub async fn persist(&self) -> std::io::Result<()> {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:422` | `pub async fn flush(&self) -> std::io::Result<()> {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:497` | `pub async fn get_rollout_history(path: &Path) -> std::io::Result<InitialHistory> {` |
| `pub_fn` | `codex-rs/core/src/rollout/recorder.rs:514` | `pub async fn shutdown(&self) -> std::io::Result<()> {` |
...
| `pub_enum` | `codex-rs/core/src/sandboxing/mod.rs:67` | `pub enum SandboxPreference {` |
| `pub_struct` | `codex-rs/core/src/sandboxing/mod.rs:83` | `pub struct SandboxManager;` |
| `pub_fn` | `codex-rs/core/src/sandboxing/mod.rs:86` | `pub fn new() -> Self {` |
| `pub_fn` | `codex-rs/core/src/sandboxing/mod.rs:201` | `pub fn denied(&self, sandbox: SandboxType, out: &ExecToolCallOutput) -> bool {` |
| `pub_fn` | `codex-rs/core/src/sandboxing/mod.rs:206` | `pub async fn execute_env(` |
...
| `pub_struct` | `codex-rs/core/src/skills/manager.rs:22` | `pub struct SkillsManager {` |
| `pub_fn` | `codex-rs/core/src/skills/manager.rs:28` | `pub fn new(codex_home: PathBuf) -> Self {` |
| `pub_fn` | `codex-rs/core/src/skills/manager.rs:41` | `pub fn skills_for_config(&self, config: &Config) -> SkillLoadOutcome {` |
| `pub_fn` | `codex-rs/core/src/skills/manager.rs:63` | `pub async fn skills_for_cwd(&self, cwd: &Path, force_reload: bool) -> SkillLoadOutcome {` |
| `pub_fn` | `codex-rs/core/src/skills/manager.rs:118` | `pub fn clear_cache(&self) {` |
...
| `pub_mod` | `codex-rs/core/src/skills/mod.rs:6` | `pub mod remote;` |
| `pub_mod` | `codex-rs/core/src/skills/mod.rs:7` | `pub mod render;` |
| `pub_mod` | `codex-rs/core/src/skills/mod.rs:8` | `pub mod system;` |
...
| `pub_struct` | `codex-rs/core/src/skills/remote.rs:17` | `pub struct RemoteSkillSummary {` |
| `pub_struct` | `codex-rs/core/src/skills/remote.rs:24` | `pub struct RemoteSkillDownload {` |
| `pub_struct` | `codex-rs/core/src/skills/remote.rs:32` | `pub struct RemoteSkillDownloadResult {` |
| `pub_struct` | `codex-rs/core/src/skills/remote.rs:39` | `pub struct RemoteSkillFileRange {` |
| `pub_fn` | `codex-rs/core/src/skills/remote.rs:76` | `pub async fn list_remote_skills(config: &Config) -> Result<Vec<RemoteSkillSummary>> {` |
| `pub_fn` | `codex-rs/core/src/skills/remote.rs:110` | `pub async fn download_remote_skill(` |
...
| `pub_fn` | `codex-rs/core/src/state_db.rs:80` | `pub async fn get_state_db(config: &Config, otel: Option<&OtelManager>) -> Option<StateDbHandle> {` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:100` | `pub async fn open_if_present(codex_home: &Path, default_provider: &str) -> Option<StateDbHandle> {` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:161` | `pub async fn list_thread_ids_db(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:215` | `pub async fn list_threads_db(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:267` | `pub async fn find_rollout_path_by_id(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:283` | `pub async fn get_dynamic_tools(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:299` | `pub async fn persist_dynamic_tools(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:314` | `pub async fn get_thread_memory(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:330` | `pub async fn upsert_thread_memory(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:351` | `pub async fn get_last_n_thread_memories_for_cwd(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:368` | `pub async fn reconcile_rollout(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:436` | `pub async fn read_repair_rollout_path(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:486` | `pub async fn apply_rollout_items(` |
| `pub_fn` | `codex-rs/core/src/state_db.rs:521` | `pub fn record_discrepancy(stage: &str, reason: &str) {` |
| `pub_fn` | `codex-rs/core/src/tasks/mod.rs:180` | `pub async fn abort_all_tasks(self: &Arc<Self>, reason: TurnAbortReason) {` |
| `pub_fn` | `codex-rs/core/src/tasks/mod.rs:187` | `pub async fn on_task_finished(` |
...
| `pub_struct` | `codex-rs/core/src/thread_manager.rs:88` | `pub struct NewThread {` |
| `pub_struct` | `codex-rs/core/src/thread_manager.rs:96` | `pub struct ThreadManager {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:120` | `pub fn new(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:148` | `pub fn with_models_provider(auth: CodexAuth, provider: ModelProviderInfo) -> Self {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:159` | `pub fn with_models_provider_and_home(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:188` | `pub fn session_source(&self) -> SessionSource {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:192` | `pub fn skills_manager(&self) -> Arc<SkillsManager> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:196` | `pub fn subscribe_file_watcher(&self) -> broadcast::Receiver<FileWatcherEvent> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:200` | `pub fn get_models_manager(&self) -> Arc<ModelsManager> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:204` | `pub async fn list_models(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:215` | `pub fn list_collaboration_modes(&self) -> Vec<CollaborationModeMask> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:219` | `pub async fn list_thread_ids(&self) -> Vec<ThreadId> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:223` | `pub async fn refresh_mcp_servers(&self, refresh_config: McpServerRefreshConfig) {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:244` | `pub fn subscribe_thread_created(&self) -> broadcast::Receiver<ThreadId> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:248` | `pub async fn get_thread(&self, thread_id: ThreadId) -> CodexResult<Arc<CodexThread>> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:252` | `pub async fn start_thread(&self, config: Config) -> CodexResult<NewThread> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:256` | `pub async fn start_thread_with_tools(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:272` | `pub async fn resume_thread_from_rollout(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:283` | `pub async fn resume_thread_with_history(` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:303` | `pub async fn remove_thread(&self, thread_id: &ThreadId) -> Option<Arc<CodexThread>> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:308` | `pub async fn remove_and_close_all_threads(&self) -> CodexResult<()> {` |
| `pub_fn` | `codex-rs/core/src/thread_manager.rs:320` | `pub async fn fork_thread(` |
...
| `pub_fn` | `codex-rs/core/src/tools/context.rs:72` | `pub fn log_preview(&self) -> String {` |
| `pub_fn` | `codex-rs/core/src/tools/context.rs:81` | `pub fn success_for_logging(&self) -> bool {` |
| `pub_fn` | `codex-rs/core/src/tools/context.rs:88` | `pub fn into_response(self, call_id: &str, payload: &ToolPayload) -> ResponseInputItem {` |
...
| `pub_struct` | `codex-rs/core/src/tools/handlers/apply_patch.rs:35` | `pub struct ApplyPatchHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/collab.rs:34` | `pub struct CollabHandler;` |
| `pub_fn` | `codex-rs/core/src/tools/handlers/collab.rs:107` | `pub async fn handle(` |
| `pub_fn` | `codex-rs/core/src/tools/handlers/collab.rs:211` | `pub async fn handle(` |
| `pub_fn` | `codex-rs/core/src/tools/handlers/collab.rs:298` | `pub async fn handle(` |
| `pub_fn` | `codex-rs/core/src/tools/handlers/collab.rs:454` | `pub async fn handle(` |
| `pub_mod` | `codex-rs/core/src/tools/handlers/collab.rs:617` | `pub mod close_agent {` |
| `pub_fn` | `codex-rs/core/src/tools/handlers/collab.rs:626` | `pub async fn handle(` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/dynamic.rs:20` | `pub struct DynamicToolHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/get_memory.rs:15` | `pub struct GetMemoryHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/grep_files.rs:18` | `pub struct GrepFilesHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/list_dir.rs:21` | `pub struct ListDirHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/mcp.rs:13` | `pub struct McpHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/mcp_resource.rs:34` | `pub struct McpResourceHandler;` |
| `pub_mod` | `codex-rs/core/src/tools/handlers/mod.rs:1` | `pub mod apply_patch;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/plan.rs:20` | `pub struct PlanHandler;` |
| `pub_static` | `codex-rs/core/src/tools/handlers/plan.rs:22` | `pub static PLAN_TOOL: LazyLock<ToolSpec> = LazyLock::new(|| {` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/read_file.rs:17` | `pub struct ReadFileHandler;` |
...
| `pub_struct` | `codex-rs/core/src/tools/handlers/request_user_input.rs:48` | `pub struct RequestUserInputHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/shell.rs:30` | `pub struct ShellHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/shell.rs:32` | `pub struct ShellCommandHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/test_sync.rs:21` | `pub struct TestSyncHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/unified_exec.rs:26` | `pub struct UnifiedExecHandler;` |
| `pub_struct` | `codex-rs/core/src/tools/handlers/view_image.rs:19` | `pub struct ViewImageHandler;` |
...
| `pub_fn` | `codex-rs/core/src/tools/orchestrator.rs:30` | `pub fn new() -> Self {` |
| `pub_enum` | `codex-rs/core/src/tools/registry.rs:20` | `pub enum ToolKind {` |
| `pub_trait` | `codex-rs/core/src/tools/registry.rs:26` | `pub trait ToolHandler: Send + Sync {` |
| `pub_struct` | `codex-rs/core/src/tools/registry.rs:50` | `pub struct ToolRegistry {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:55` | `pub fn new(handlers: HashMap<String, Arc<dyn ToolHandler>>) -> Self {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:59` | `pub fn handler(&self, name: &str) -> Option<Arc<dyn ToolHandler>> {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:71` | `pub async fn dispatch(` |
| `pub_struct` | `codex-rs/core/src/tools/registry.rs:173` | `pub struct ConfiguredToolSpec {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:179` | `pub fn new(spec: ToolSpec, supports_parallel_tool_calls: bool) -> Self {` |
| `pub_struct` | `codex-rs/core/src/tools/registry.rs:187` | `pub struct ToolRegistryBuilder {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:193` | `pub fn new() -> Self {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:200` | `pub fn push_spec(&mut self, spec: ToolSpec) {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:204` | `pub fn push_spec_with_parallel_support(` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:213` | `pub fn register_handler(&mut self, name: impl Into<String>, handler: Arc<dyn ToolHandler>) {` |
| `pub_fn` | `codex-rs/core/src/tools/registry.rs:242` | `pub fn build(self) -> (Vec<ConfiguredToolSpec>, ToolRegistry) {` |
| `pub_struct` | `codex-rs/core/src/tools/router.rs:25` | `pub struct ToolCall {` |
| `pub_struct` | `codex-rs/core/src/tools/router.rs:31` | `pub struct ToolRouter {` |
| `pub_fn` | `codex-rs/core/src/tools/router.rs:37` | `pub fn from_config(` |
| `pub_fn` | `codex-rs/core/src/tools/router.rs:48` | `pub fn specs(&self) -> Vec<ToolSpec> {` |
| `pub_fn` | `codex-rs/core/src/tools/router.rs:55` | `pub fn tool_supports_parallel(&self, tool_name: &str) -> bool {` |
| `pub_fn` | `codex-rs/core/src/tools/router.rs:63` | `pub async fn build_tool_call(` |
| `pub_fn` | `codex-rs/core/src/tools/router.rs:135` | `pub async fn dispatch_tool_call(` |
...
| `pub_fn` | `codex-rs/core/src/tools/sandboxing.rs:282` | `pub fn env_for(` |
| `pub_fn` | `codex-rs/core/src/tools/spec.rs:46` | `pub fn new(params: &ToolsConfigParams) -> Self {` |
| `pub_enum` | `codex-rs/core/src/tools/spec.rs:99` | `pub enum JsonSchema {` |
| `pub_enum` | `codex-rs/core/src/tools/spec.rs:135` | `pub enum AdditionalProperties {` |
| `pub_fn` | `codex-rs/core/src/tools/spec.rs:1086` | `pub fn create_tools_json_for_responses_api(` |
| `pub_fn` | `codex-rs/core/src/tools/spec.rs:1153` | `pub fn parse_tool_input_schema(input_schema: &JsonValue) -> Result<JsonSchema, serde_json::Error> {` |
...
| `pub_fn` | `codex-rs/core/src/turn_metadata.rs:59` | `pub async fn build_turn_metadata_header(cwd: PathBuf) -> Option<String> {` |
...
| `pub_fn` | `codex-rs/core/src/util.rs:40` | `pub fn backoff(attempt: u64) -> Duration {` |
...
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:14` | `pub mod process;` |
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:15` | `pub mod responses;` |
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:16` | `pub mod streaming_sse;` |
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:17` | `pub mod test_codex;` |
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:18` | `pub mod test_codex_exec;` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:30` | `pub fn test_path_buf_with_windows(unix_path: &str, windows_path: Option<&str>) -> PathBuf {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:49` | `pub fn test_path_buf(unix_path: &str) -> PathBuf {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:53` | `pub fn test_absolute_path_with_windows(` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:61` | `pub fn test_absolute_path(unix_path: &str) -> AbsolutePathBuf {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:65` | `pub fn test_tmp_path() -> AbsolutePathBuf {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:69` | `pub fn test_tmp_path_buf() -> PathBuf {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:76` | `pub async fn load_default_config_for_test(codex_home: &TempDir) -> Config {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:109` | `pub fn load_sse_fixture(path: impl AsRef<std::path::Path>) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:129` | `pub fn load_sse_fixture_with_id_from_str(raw: &str, id: &str) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:187` | `pub fn sandbox_env_var() -> &'static str {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:191` | `pub fn sandbox_network_env_var() -> &'static str {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:195` | `pub fn format_with_current_shell(command: &str) -> Vec<String> {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:199` | `pub fn format_with_current_shell_display(command: &str) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:204` | `pub fn format_with_current_shell_non_login(command: &str) -> Vec<String> {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:208` | `pub fn format_with_current_shell_display_non_login(command: &str) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:214` | `pub fn stdio_server_bin() -> Result<String, CargoBinError> {` |
| `pub_mod` | `codex-rs/core/tests/common/lib.rs:218` | `pub mod fs_wait {` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:232` | `pub async fn wait_for_path_exists(` |
| `pub_fn` | `codex-rs/core/tests/common/lib.rs:240` | `pub async fn wait_for_matching_file(` |
...
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:36` | `pub struct ResponseMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:47` | `pub fn single_request(&self) -> ResponsesRequest {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:55` | `pub fn requests(&self) -> Vec<ResponsesRequest> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:59` | `pub fn last_request(&self) -> Option<ResponsesRequest> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:65` | `pub fn saw_function_call(&self, call_id: &str) -> bool {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:73` | `pub fn function_call_output_text(&self, call_id: &str) -> Option<String> {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:81` | `pub struct ResponsesRequest(wiremock::Request);` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:100` | `pub fn body_json(&self) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:111` | `pub fn body_bytes(&self) -> Vec<u8> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:115` | `pub fn instructions_text(&self) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:123` | `pub fn message_input_texts(&self, role: &str) -> Vec<String> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:134` | `pub fn input(&self) -> Vec<Value> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:141` | `pub fn inputs_of_type(&self, ty: &str) -> Vec<Value> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:149` | `pub fn function_call_output(&self, call_id: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:153` | `pub fn custom_tool_call_output(&self, call_id: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:157` | `pub fn call_output(&self, call_id: &str, call_type: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:169` | `pub fn has_function_call(&self, call_id: &str) -> bool {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:178` | `pub fn function_call_output_text(&self, call_id: &str) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:189` | `pub fn function_call_output_content_and_success(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:196` | `pub fn custom_tool_call_output_content_and_success(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:225` | `pub fn header(&self, name: &str) -> Option<String> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:233` | `pub fn path(&self) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:237` | `pub fn query_param(&self, name: &str) -> Option<String> {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:247` | `pub struct WebSocketRequest {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:252` | `pub fn body_json(&self) -> Value {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:258` | `pub struct WebSocketHandshake {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:263` | `pub fn header(&self, name: &str) -> Option<String> {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:272` | `pub struct WebSocketConnectionConfig {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:282` | `pub struct WebSocketTestServer {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:291` | `pub fn uri(&self) -> &str {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:295` | `pub fn connections(&self) -> Vec<Vec<WebSocketRequest>> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:299` | `pub fn single_connection(&self) -> Vec<WebSocketRequest> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:307` | `pub fn handshakes(&self) -> Vec<WebSocketHandshake> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:315` | `pub async fn wait_for_handshakes(&self, expected: usize, timeout: Duration) -> bool {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:334` | `pub fn single_handshake(&self) -> WebSocketHandshake {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:342` | `pub async fn shutdown(self) {` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:349` | `pub struct ModelsMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:360` | `pub fn requests(&self) -> Vec<wiremock::Request> {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:364` | `pub fn single_request_path(&self) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:395` | `pub fn sse(events: Vec<Value>) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:410` | `pub fn sse_completed(id: &str) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:415` | `pub fn ev_completed(id: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:425` | `pub fn ev_done() -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:435` | `pub fn ev_response_created(id: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:444` | `pub fn ev_completed_with_tokens(id: &str, total_tokens: i64) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:461` | `pub fn ev_assistant_message(id: &str, text: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:473` | `pub fn ev_message_item_added(id: &str, text: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:485` | `pub fn ev_output_text_delta(delta: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:492` | `pub fn ev_reasoning_item(id: &str, summary: &[&str], raw_content: &[&str]) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:524` | `pub fn ev_reasoning_item_added(id: &str, summary: &[&str]) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:540` | `pub fn ev_reasoning_summary_text_delta(delta: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:548` | `pub fn ev_reasoning_text_delta(delta: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:556` | `pub fn ev_web_search_call_added_partial(id: &str, status: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:567` | `pub fn ev_web_search_call_done(id: &str, status: &str, query: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:579` | `pub fn ev_function_call(call_id: &str, name: &str, arguments: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:591` | `pub fn ev_custom_tool_call(call_id: &str, name: &str, input: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:603` | `pub fn ev_local_shell_call(call_id: &str, status: &str, command: Vec<&str>) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:618` | `pub fn ev_apply_patch_call(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:639` | `pub fn ev_apply_patch_custom_tool_call(call_id: &str, patch: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:654` | `pub fn ev_apply_patch_function_call(call_id: &str, patch: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:669` | `pub fn ev_shell_command_call(call_id: &str, command: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:674` | `pub fn ev_shell_command_call_with_args(call_id: &str, args: &serde_json::Value) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:679` | `pub fn ev_apply_patch_shell_call(call_id: &str, patch: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:686` | `pub fn ev_apply_patch_shell_call_via_heredoc(call_id: &str, patch: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:694` | `pub fn ev_apply_patch_shell_command_call_via_heredoc(call_id: &str, patch: &str) -> Value {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:701` | `pub fn sse_failed(id: &str, code: &str, message: &str) -> String {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:711` | `pub fn sse_response(body: String) -> ResponseTemplate {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:717` | `pub async fn mount_response_once(server: &MockServer, response: ResponseTemplate) -> ResponseMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:780` | `pub async fn mount_sse_once(server: &MockServer, body: String) -> ResponseMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:810` | `pub async fn mount_compact_json_once(server: &MockServer, body: serde_json::Value) -> ResponseMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:823` | `pub async fn mount_models_once(server: &MockServer, body: ModelsResponse) -> ModelsMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:836` | `pub async fn mount_models_once_with_delay(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:854` | `pub async fn mount_models_once_with_etag(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:873` | `pub async fn start_mock_server() -> MockServer {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:890` | `pub async fn start_websocket_server(connections: Vec<Vec<Vec<Value>>>) -> WebSocketTestServer {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:902` | `pub async fn start_websocket_server_with_headers(` |
| `pub_struct` | `codex-rs/core/tests/common/responses.rs:1043` | `pub struct FunctionCallResponseMocks {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:1048` | `pub async fn mount_function_call_agent_response(` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:1076` | `pub async fn mount_sse_sequence(server: &MockServer, bodies: Vec<String>) -> ResponseMock {` |
| `pub_fn` | `codex-rs/core/tests/common/responses.rs:1115` | `pub async fn mount_response_sequence(` |
...
| `pub_static` | `codex-rs/core/tests/suite/mod.rs:22` | `pub static CODEX_ALIASES_TEMP_DIR: TestCodexAliasesGuard = unsafe {` |
...
| `pub_struct` | `codex-rs/exec-server/src/posix/mcp.rs:153` | `pub struct CodexSandboxStateUpdateMethod;` |
...
| `pub_struct` | `codex-rs/exec-server/tests/common/lib.rs:143` | `pub struct InteractiveClient {` |
| `pub_struct` | `codex-rs/exec/src/cli.rs:10` | `pub struct Cli {` |
| `pub_enum` | `codex-rs/exec/src/cli.rs:109` | `pub enum Command {` |
| `pub_struct` | `codex-rs/exec/src/cli.rs:150` | `pub struct ResumeArgs {` |
| `pub_struct` | `codex-rs/exec/src/cli.rs:209` | `pub struct ReviewArgs {` |
| `pub_enum` | `codex-rs/exec/src/cli.rs:245` | `pub enum Color {` |
...
| `pub_fn` | `codex-rs/exec/src/lib.rs:89` | `pub async fn run_main(cli: Cli, codex_linux_sandbox_exe: Option<PathBuf>) -> anyhow::Result<()> {` |
...
| `fn_main` | `codex-rs/linux-sandbox/build.rs:5` | `fn main() {` |
| `pub_fn` | `codex-rs/linux-sandbox/src/lib.rs:16` | `pub fn run_main() -> ! {` |
| `pub_fn` | `codex-rs/linux-sandbox/src/lib.rs:21` | `pub fn run_main() -> ! {` |
| `pub_struct` | `codex-rs/linux-sandbox/src/linux_run_main.rs:20` | `pub struct LandlockCommand {` |
| `pub_fn` | `codex-rs/linux-sandbox/src/linux_run_main.rs:61` | `pub fn run_main() -> ! {` |
...
| `pub_fn` | `codex-rs/mcp-server/tests/common/mock_model_server.rs:13` | `pub async fn create_mock_responses_server(responses: Vec<String>) -> MockServer {` |
| `pub_fn` | `codex-rs/mcp-server/tests/common/responses.rs:6` | `pub fn create_shell_command_sse_response(` |
| `pub_fn` | `codex-rs/mcp-server/tests/common/responses.rs:26` | `pub fn create_final_assistant_message_sse_response(message: &str) -> anyhow::Result<String> {` |
| `pub_fn` | `codex-rs/mcp-server/tests/common/responses.rs:35` | `pub fn create_apply_patch_sse_response(` |
| `pub_struct` | `codex-rs/mcp-server/tests/suite/codex_tool.rs:464` | `pub struct McpHandle {` |
...
| `pub_enum` | `codex-rs/network-proxy/src/config.rs:72` | `pub enum NetworkMode {` |
| `pub_fn` | `codex-rs/network-proxy/src/config.rs:83` | `pub fn allows_method(self, method: &str) -> bool {` |
| `pub_struct` | `codex-rs/network-proxy/src/config.rs:172` | `pub struct RuntimeConfig {` |
| `pub_fn` | `codex-rs/network-proxy/src/config.rs:178` | `pub fn resolve_runtime(cfg: &NetworkProxyConfig) -> Result<RuntimeConfig> {` |
| `pub_fn` | `codex-rs/network-proxy/src/http_proxy.rs:72` | `pub async fn run_http_proxy(` |
...
| `pub_const` | `codex-rs/network-proxy/src/network_policy.rs:19` | `pub const fn as_policy_protocol(self) -> &'static str {` |
| `pub_enum` | `codex-rs/network-proxy/src/network_policy.rs:30` | `pub enum NetworkPolicyDecision {` |
| `pub_const` | `codex-rs/network-proxy/src/network_policy.rs:36` | `pub const fn as_str(self) -> &'static str {` |
| `pub_enum` | `codex-rs/network-proxy/src/network_policy.rs:45` | `pub enum NetworkDecisionSource {` |
| `pub_const` | `codex-rs/network-proxy/src/network_policy.rs:53` | `pub const fn as_str(self) -> &'static str {` |
| `pub_struct` | `codex-rs/network-proxy/src/network_policy.rs:64` | `pub struct NetworkPolicyRequest {` |
| `pub_struct` | `codex-rs/network-proxy/src/network_policy.rs:74` | `pub struct NetworkPolicyRequestArgs {` |
| `pub_fn` | `codex-rs/network-proxy/src/network_policy.rs:85` | `pub fn new(args: NetworkPolicyRequestArgs) -> Self {` |
| `pub_enum` | `codex-rs/network-proxy/src/network_policy.rs:108` | `pub enum NetworkDecision {` |
| `pub_fn` | `codex-rs/network-proxy/src/network_policy.rs:118` | `pub fn deny(reason: impl Into<String>) -> Self {` |
| `pub_fn` | `codex-rs/network-proxy/src/network_policy.rs:122` | `pub fn deny_with_source(reason: impl Into<String>, source: NetworkDecisionSource) -> Self {` |
| `pub_fn` | `codex-rs/network-proxy/src/network_policy.rs:136` | `pub fn ask_with_source(reason: impl Into<String>, source: NetworkDecisionSource) -> Self {` |
| `pub_trait` | `codex-rs/network-proxy/src/network_policy.rs:157` | `pub trait NetworkPolicyDecider: Send + Sync + 'static {` |
...
| `pub_struct` | `codex-rs/network-proxy/src/responses.rs:16` | `pub struct PolicyDecisionDetails<'a> {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:36` | `pub fn text_response(status: StatusCode, body: &str) -> Response {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:62` | `pub fn blocked_header_value(reason: &str) -> &'static str {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:71` | `pub fn blocked_message(reason: &str) -> &'static str {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:85` | `pub fn policy_decision_prefix(details: &PolicyDecisionDetails<'_>) -> String {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:104` | `pub fn blocked_message_with_policy(reason: &str, details: &PolicyDecisionDetails<'_>) -> String {` |
| `pub_fn` | `codex-rs/network-proxy/src/responses.rs:112` | `pub fn blocked_text_response_with_policy(` |
...
| `pub_fn` | `codex-rs/network-proxy/src/socks5.rs:44` | `pub async fn run_socks5(` |
| `pub_struct` | `codex-rs/ollama/src/client.rs:21` | `pub struct OllamaClient {` |
| `pub_fn` | `codex-rs/ollama/src/client.rs:31` | `pub async fn try_from_oss_provider(config: &Config) -> io::Result<Self> {` |
| `pub_fn` | `codex-rs/ollama/src/client.rs:101` | `pub async fn fetch_models(&self) -> io::Result<Vec<String>> {` |
| `pub_fn` | `codex-rs/ollama/src/client.rs:127` | `pub async fn fetch_version(&self) -> io::Result<Option<Version>> {` |
| `pub_fn` | `codex-rs/ollama/src/client.rs:154` | `pub async fn pull_model_stream(` |
| `pub_fn` | `codex-rs/ollama/src/client.rs:212` | `pub async fn pull_with_reporter(` |
| `pub_const` | `codex-rs/ollama/src/lib.rs:16` | `pub const DEFAULT_OSS_MODEL: &str = "gpt-oss:20b";` |
| `pub_fn` | `codex-rs/ollama/src/lib.rs:22` | `pub async fn ensure_oss_ready(config: &Config) -> std::io::Result<()> {` |
| `pub_fn` | `codex-rs/ollama/src/lib.rs:62` | `pub async fn ensure_responses_supported(provider: &ModelProviderInfo) -> std::io::Result<()> {` |
...
| `pub_enum` | `codex-rs/otel/src/lib.rs:29` | `pub enum ToolDecisionSource {` |
| `pub_enum` | `codex-rs/otel/src/lib.rs:36` | `pub enum TelemetryAuthMode {` |
| `pub_struct` | `codex-rs/otel/src/lib.rs:42` | `pub struct OtelEventMetadata {` |
| `pub_struct` | `codex-rs/otel/src/lib.rs:57` | `pub struct OtelManager {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:64` | `pub fn with_model(mut self, model: &str, slug: &str) -> Self {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:70` | `pub fn with_metrics(mut self, metrics: MetricsClient) -> Self {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:76` | `pub fn with_metrics_without_metadata_tags(mut self, metrics: MetricsClient) -> Self {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:82` | `pub fn with_metrics_config(self, config: MetricsConfig) -> MetricsResult<Self> {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:87` | `pub fn with_provider_metrics(self, provider: &OtelProvider) -> Self {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:94` | `pub fn counter(&self, name: &str, inc: i64, tags: &[(&str, &str)]) {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:109` | `pub fn histogram(&self, name: &str, value: i64, tags: &[(&str, &str)]) {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:124` | `pub fn record_duration(&self, name: &str, duration: Duration, tags: &[(&str, &str)]) {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:139` | `pub fn start_timer(&self, name: &str, tags: &[(&str, &str)]) -> Result<Timer, MetricsError> {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:147` | `pub fn shutdown_metrics(&self) -> MetricsResult<()> {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:154` | `pub fn snapshot_metrics(&self) -> MetricsResult<ResourceMetrics> {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:162` | `pub fn reset_runtime_metrics(&self) {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:172` | `pub fn runtime_metrics_summary(&self) -> Option<RuntimeMetricsSummary> {` |
| `pub_fn` | `codex-rs/otel/src/lib.rs:228` | `pub fn start_global_timer(name: &str, tags: &[(&str, &str)]) -> MetricsResult<Timer> {` |
| `pub_struct` | `codex-rs/otel/src/metrics/client.rs:184` | `pub struct MetricsClient(std::sync::Arc<MetricsClientInner>);` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:188` | `pub fn new(config: MetricsConfig) -> Result<Self> {` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:244` | `pub fn counter(&self, name: &str, inc: i64, tags: &[(&str, &str)]) -> Result<()> {` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:249` | `pub fn histogram(&self, name: &str, value: i64, tags: &[(&str, &str)]) -> Result<()> {` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:254` | `pub fn record_duration(` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:267` | `pub fn start_timer(` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:276` | `pub fn snapshot(&self) -> Result<ResourceMetrics> {` |
| `pub_fn` | `codex-rs/otel/src/metrics/client.rs:288` | `pub fn shutdown(&self) -> Result<()> {` |
...
| `pub_struct` | `codex-rs/otel/src/metrics/runtime_metrics.rs:23` | `pub struct RuntimeMetricTotals {` |
| `pub_fn` | `codex-rs/otel/src/metrics/runtime_metrics.rs:29` | `pub fn is_empty(self) -> bool {` |
| `pub_fn` | `codex-rs/otel/src/metrics/runtime_metrics.rs:33` | `pub fn merge(&mut self, other: Self) {` |
| `pub_struct` | `codex-rs/otel/src/metrics/runtime_metrics.rs:40` | `pub struct RuntimeMetricsSummary {` |
| `pub_fn` | `codex-rs/otel/src/metrics/runtime_metrics.rs:55` | `pub fn is_empty(self) -> bool {` |
| `pub_fn` | `codex-rs/otel/src/metrics/runtime_metrics.rs:69` | `pub fn merge(&mut self, other: Self) {` |
| `pub_fn` | `codex-rs/otel/src/metrics/runtime_metrics.rs:95` | `pub fn responses_api_summary(&self) -> RuntimeMetricsSummary {` |
...
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:62` | `pub fn new(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:93` | `pub fn apply_traceparent_parent(&self, span: &Span) {` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:99` | `pub fn record_responses(&self, handle_responses_span: &Span, event: &ResponseEvent) {` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:120` | `pub fn conversation_starts(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:175` | `pub fn record_api_request(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:217` | `pub fn record_websocket_request(&self, duration: Duration, error: Option<&str>) {` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:248` | `pub fn record_websocket_event(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:500` | `pub fn sse_event_completed(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:530` | `pub fn user_prompt(&self, items: &[UserInput]) {` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:563` | `pub fn tool_decision(` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:625` | `pub fn log_tool_failed(&self, tool_name: &str, error: &str) {` |
| `pub_fn` | `codex-rs/otel/src/traces/otel_manager.rs:647` | `pub fn tool_result_with_tags(` |
...
| `pub_enum` | `codex-rs/protocol/src/config_types.rs:109` | `pub enum WebSearchMode {` |
| `pub_enum` | `codex-rs/protocol/src/config_types.rs:119` | `pub enum ForcedLoginMethod {` |
| `pub_enum` | `codex-rs/protocol/src/config_types.rs:129` | `pub enum TrustLevel {` |
| `pub_enum` | `codex-rs/protocol/src/config_types.rs:159` | `pub enum AltScreenMode {` |
| `pub_enum` | `codex-rs/protocol/src/config_types.rs:174` | `pub enum ModeKind {` |
| `pub_const` | `codex-rs/protocol/src/config_types.rs:196` | `pub const TUI_VISIBLE_COLLABORATION_MODES: [ModeKind; 2] = [ModeKind::Default, ModeKind::Plan];` |
| `pub_const` | `codex-rs/protocol/src/config_types.rs:199` | `pub const fn display_name(self) -> &'static str {` |
| `pub_const` | `codex-rs/protocol/src/config_types.rs:208` | `pub const fn is_tui_visible(self) -> bool {` |
| `pub_const` | `codex-rs/protocol/src/config_types.rs:212` | `pub const fn allows_request_user_input(self) -> bool {` |
| `pub_struct` | `codex-rs/protocol/src/config_types.rs:220` | `pub struct CollaborationMode {` |
| `pub_fn` | `codex-rs/protocol/src/config_types.rs:231` | `pub fn model(&self) -> &str {` |
| `pub_fn` | `codex-rs/protocol/src/config_types.rs:235` | `pub fn reasoning_effort(&self) -> Option<ReasoningEffort> {` |
| `pub_fn` | `codex-rs/protocol/src/config_types.rs:246` | `pub fn with_updates(` |
| `pub_fn` | `codex-rs/protocol/src/config_types.rs:271` | `pub fn apply_mask(&self, mask: &CollaborationModeMask) -> Self {` |
| `pub_struct` | `codex-rs/protocol/src/config_types.rs:289` | `pub struct Settings {` |
| `pub_struct` | `codex-rs/protocol/src/config_types.rs:298` | `pub struct CollaborationModeMask {` |
...
| `pub_enum` | `codex-rs/protocol/src/dynamic_tools.rs:34` | `pub enum DynamicToolCallOutputContentItem {` |
| `pub_enum` | `codex-rs/protocol/src/items.rs:21` | `pub enum TurnItem {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:31` | `pub struct UserMessageItem {` |
| `pub_enum` | `codex-rs/protocol/src/items.rs:39` | `pub enum AgentMessageContent {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:49` | `pub struct AgentMessageItem {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:62` | `pub struct PlanItem {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:68` | `pub struct ReasoningItem {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:76` | `pub struct WebSearchItem {` |
| `pub_struct` | `codex-rs/protocol/src/items.rs:83` | `pub struct ContextCompactionItem {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:88` | `pub fn new() -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:94` | `pub fn as_legacy_event(&self) -> EventMsg {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:106` | `pub fn new(content: &[UserInput]) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:113` | `pub fn as_legacy_event(&self) -> EventMsg {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:124` | `pub fn message(&self) -> String {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:135` | `pub fn text_elements(&self) -> Vec<TextElement> {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:162` | `pub fn image_urls(&self) -> Vec<String> {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:172` | `pub fn local_image_paths(&self) -> Vec<std::path::PathBuf> {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:184` | `pub fn new(content: &[AgentMessageContent]) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:192` | `pub fn as_legacy_events(&self) -> Vec<EventMsg> {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:207` | `pub fn as_legacy_events(&self, show_raw_agent_reasoning: bool) -> Vec<EventMsg> {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:230` | `pub fn as_legacy_event(&self) -> EventMsg {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:240` | `pub fn id(&self) -> String {` |
| `pub_fn` | `codex-rs/protocol/src/items.rs:251` | `pub fn as_legacy_events(&self, show_raw_agent_reasoning: bool) -> Vec<EventMsg> {` |
...
| `pub_enum` | `codex-rs/protocol/src/models.rs:81` | `pub enum MessagePhase {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:93` | `pub enum ResponseItem {` |
| `pub_const` | `codex-rs/protocol/src/models.rs:198` | `pub const BASE_INSTRUCTIONS_DEFAULT: &str = include_str!("prompts/base_instructions/default.md");` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:203` | `pub struct BaseInstructions {` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:219` | `pub struct DeveloperInstructions {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:244` | `pub fn from(` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:274` | `pub fn into_text(self) -> String {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:278` | `pub fn concat(self, other: impl Into<DeveloperInstructions>) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:287` | `pub fn model_switch_message(model_instructions: String) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:293` | `pub fn personality_spec_message(spec: String) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:300` | `pub fn from_policy(` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:334` | `pub fn from_collaboration_mode(collaboration_mode: &CollaborationMode) -> Option<Self> {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:408` | `pub fn format_allow_prefixes(prefixes: Vec<Vec<String>>) -> Option<String> {` |
| `pub_const` | `codex-rs/protocol/src/models.rs:507` | `pub const VIEW_IMAGE_TOOL_NAME: &str = "view_image";` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:515` | `pub fn image_open_tag_text() -> String {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:519` | `pub fn image_close_tag_text() -> String {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:523` | `pub fn local_image_label_text(label_number: usize) -> String {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:527` | `pub fn local_image_open_tag_text(label_number: usize) -> String {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:532` | `pub fn is_local_image_open_tag_text(text: &str) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:537` | `pub fn is_local_image_close_tag_text(text: &str) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:541` | `pub fn is_image_open_tag_text(text: &str) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:545` | `pub fn is_image_close_tag_text(text: &str) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:572` | `pub fn local_image_content_items_with_label_number(` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:651` | `pub enum LocalShellStatus {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:659` | `pub enum LocalShellAction {` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:664` | `pub struct LocalShellExecAction {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:674` | `pub enum WebSearchAction {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:703` | `pub enum ReasoningItemReasoningSummary {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:709` | `pub enum ReasoningItemContent {` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:746` | `pub struct ShellToolCallParams {` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:767` | `pub struct ShellCommandToolCallParams {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:791` | `pub enum FunctionCallOutputContentItem {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:809` | `pub fn function_call_output_content_items_to_text(` |
| `pub_struct` | `codex-rs/protocol/src/models.rs:850` | `pub struct FunctionCallOutputPayload {` |
| `pub_enum` | `codex-rs/protocol/src/models.rs:857` | `pub enum FunctionCallOutputBody {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:869` | `pub fn to_text(&self) -> Option<String> {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:884` | `pub fn from_text(content: String) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:891` | `pub fn from_content_items(content_items: Vec<FunctionCallOutputContentItem>) -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:898` | `pub fn text_content(&self) -> Option<&str> {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:905` | `pub fn text_content_mut(&mut self) -> Option<&mut String> {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:912` | `pub fn content_items(&self) -> Option<&[FunctionCallOutputContentItem]> {` |
| `pub_fn` | `codex-rs/protocol/src/models.rs:919` | `pub fn content_items_mut(&mut self) -> Option<&mut Vec<FunctionCallOutputContentItem>> {` |
...
| `pub_struct` | `codex-rs/protocol/src/openai_models.rs:349` | `pub struct ModelInfoUpgrade {` |
| `pub_struct` | `codex-rs/protocol/src/openai_models.rs:365` | `pub struct ModelsResponse {` |
| `pub_fn` | `codex-rs/protocol/src/openai_models.rs:406` | `pub fn filter_by_auth(models: Vec<ModelPreset>, chatgpt_mode: bool) -> Vec<ModelPreset> {` |
| `pub_fn` | `codex-rs/protocol/src/openai_models.rs:416` | `pub fn merge(` |
...
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:338` | `pub enum AskForApproval {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:367` | `pub enum NetworkAccess {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:374` | `pub fn is_enabled(self) -> bool {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:383` | `pub enum SandboxPolicy {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:434` | `pub struct WritableRoot {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:442` | `pub fn is_path_writable(&self, path: &Path) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:469` | `pub fn new_read_only_policy() -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:476` | `pub fn new_workspace_write_policy() -> Self {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:486` | `pub fn has_full_disk_read_access(&self) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:490` | `pub fn has_full_disk_write_access(&self) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:499` | `pub fn has_full_network_access(&self) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:511` | `pub fn get_writable_roots_with_cwd(&self, cwd: &Path) -> Vec<WritableRoot> {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:691` | `pub struct Event {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:704` | `pub enum EventMsg {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:952` | `pub enum AgentStatus {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:972` | `pub enum CodexErrorInfo {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1003` | `pub struct RawResponseItemEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1008` | `pub struct ItemStartedEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1026` | `pub struct ItemCompletedEvent {` |
| `pub_trait` | `codex-rs/protocol/src/protocol.rs:1032` | `pub trait HasLegacyEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1043` | `pub struct AgentMessageContentDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1059` | `pub struct PlanDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1067` | `pub struct ReasoningContentDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1086` | `pub struct ReasoningRawContentDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1126` | `pub struct ExitedReviewModeEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1133` | `pub struct ErrorEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1140` | `pub struct WarningEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1145` | `pub struct ContextCompactedEvent;` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1148` | `pub struct TurnCompleteEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1153` | `pub struct TurnStartedEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1161` | `pub struct TokenUsage {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1175` | `pub struct TokenUsageInfo {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1184` | `pub fn new_or_append(` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1207` | `pub fn append_last_usage(&mut self, last: &TokenUsage) {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1212` | `pub fn fill_to_context_window(&mut self, context_window: i64) {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1227` | `pub fn full_context_window(context_window: i64) -> Self {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1239` | `pub struct TokenCountEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1245` | `pub struct RateLimitSnapshot {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1253` | `pub struct RateLimitWindow {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1265` | `pub struct CreditsSnapshot {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1275` | `pub fn is_zero(&self) -> bool {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1279` | `pub fn cached_input(&self) -> i64 {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1283` | `pub fn non_cached_input(&self) -> i64 {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1288` | `pub fn blended_total(&self) -> i64 {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1292` | `pub fn tokens_in_context_window(&self) -> i64 {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1306` | `pub fn percent_of_context_window_remaining(&self, context_window: i64) -> i64 {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1320` | `pub fn add_assign(&mut self, other: &TokenUsage) {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1330` | `pub struct FinalOutput {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1371` | `pub struct AgentMessageEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1376` | `pub struct UserMessageEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1394` | `pub struct AgentMessageDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1399` | `pub struct AgentReasoningEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1404` | `pub struct AgentReasoningRawContentEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1409` | `pub struct AgentReasoningRawContentDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1414` | `pub struct AgentReasoningSectionBreakEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1423` | `pub struct AgentReasoningDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1428` | `pub struct McpInvocation {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1438` | `pub struct McpToolCallBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1445` | `pub struct McpToolCallEndEvent {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1456` | `pub fn is_success(&self) -> bool {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1465` | `pub struct WebSearchBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1470` | `pub struct WebSearchEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1480` | `pub struct ConversationPathResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1486` | `pub struct ResumedHistory {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1493` | `pub enum InitialHistory {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1500` | `pub fn forked_from_id(&self) -> Option<ThreadId> {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1516` | `pub fn session_cwd(&self) -> Option<PathBuf> {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1524` | `pub fn get_rollout_items(&self) -> Vec<RolloutItem> {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1532` | `pub fn get_event_msgs(&self) -> Option<Vec<EventMsg>> {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1557` | `pub fn get_base_instructions(&self) -> Option<BaseInstructions> {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:1574` | `pub fn get_dynamic_tools(&self) -> Option<Vec<DynamicToolSpec>> {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1601` | `pub enum SessionSource {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1615` | `pub enum SubAgentSource {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1660` | `pub struct SessionMeta {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1697` | `pub struct SessionMetaLine {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1706` | `pub enum RolloutItem {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1715` | `pub struct CompactedItem {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1736` | `pub struct TurnContextItem {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1760` | `pub enum TruncationPolicy {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1766` | `pub struct RolloutLine {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1773` | `pub struct GitInfo {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1787` | `pub enum ReviewDelivery {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1795` | `pub enum ReviewTarget {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1821` | `pub struct ReviewRequest {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1830` | `pub struct ReviewOutputEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1850` | `pub struct ReviewFinding {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1860` | `pub struct ReviewCodeLocation {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1867` | `pub struct ReviewLineRange {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1876` | `pub enum ExecCommandSource {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1885` | `pub struct ExecCommandBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1909` | `pub struct ExecCommandEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1948` | `pub struct ViewImageToolCallEvent {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:1957` | `pub enum ExecOutputStream {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1964` | `pub struct ExecCommandOutputDeltaEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1978` | `pub struct TerminalInteractionEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1988` | `pub struct BackgroundEventEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:1993` | `pub struct DeprecationNoticeEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2002` | `pub struct UndoStartedEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2008` | `pub struct UndoCompletedEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2015` | `pub struct ThreadRolledBackEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2021` | `pub struct StreamErrorEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2033` | `pub struct StreamInfoEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2038` | `pub struct PatchApplyBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2052` | `pub struct PatchApplyEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2071` | `pub struct TurnDiffEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2076` | `pub struct GetHistoryEntryResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2085` | `pub struct McpListToolsResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2097` | `pub struct McpStartupUpdateEvent {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2107` | `pub enum McpStartupStatus {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2115` | `pub struct McpStartupCompleteEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2122` | `pub struct McpStartupFailure {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2130` | `pub enum McpAuthStatus {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2151` | `pub struct ListCustomPromptsResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2157` | `pub struct ListSkillsResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2162` | `pub struct RemoteSkillSummary {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2170` | `pub struct ListRemoteSkillsResponseEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2176` | `pub struct RemoteSkillDownloadedEvent {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2185` | `pub enum SkillScope {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2193` | `pub struct SkillMetadata {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2212` | `pub struct SkillInterface {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2228` | `pub struct SkillDependencies {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2233` | `pub struct SkillToolDependency {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2253` | `pub struct SkillErrorInfo {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2259` | `pub struct SkillsListEntry {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2266` | `pub struct SessionConfiguredEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2312` | `pub struct ThreadNameUpdatedEvent {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2322` | `pub enum ReviewDecision {` |
| `pub_fn` | `codex-rs/protocol/src/protocol.rs:2350` | `pub fn to_opaque_string(&self) -> &'static str {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2364` | `pub enum FileChange {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2378` | `pub struct Chunk {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2386` | `pub struct TurnAbortedEvent {` |
| `pub_enum` | `codex-rs/protocol/src/protocol.rs:2392` | `pub enum TurnAbortReason {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2399` | `pub struct CollabAgentSpawnBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2410` | `pub struct CollabAgentSpawnEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2425` | `pub struct CollabAgentInteractionBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2438` | `pub struct CollabAgentInteractionEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2453` | `pub struct CollabWaitingBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2463` | `pub struct CollabWaitingEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2473` | `pub struct CollabCloseBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2483` | `pub struct CollabCloseEndEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2496` | `pub struct CollabResumeBeginEvent {` |
| `pub_struct` | `codex-rs/protocol/src/protocol.rs:2506` | `pub struct CollabResumeEndEvent {` |
...
| `pub_type` | `codex-rs/rmcp-client/src/rmcp_client.rs:146` | `pub type Elicitation = CreateElicitationRequestParam;` |
| `pub_type` | `codex-rs/rmcp-client/src/rmcp_client.rs:147` | `pub type ElicitationResponse = CreateElicitationResult;` |
| `pub_type` | `codex-rs/rmcp-client/src/rmcp_client.rs:150` | `pub type SendElicitation = Box<` |
| `pub_struct` | `codex-rs/rmcp-client/src/rmcp_client.rs:154` | `pub struct ToolWithConnectorId {` |
| `pub_struct` | `codex-rs/rmcp-client/src/rmcp_client.rs:160` | `pub struct ListToolsWithConnectorIdResult {` |
| `pub_struct` | `codex-rs/rmcp-client/src/rmcp_client.rs:167` | `pub struct RmcpClient {` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:172` | `pub async fn new_stdio_client(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:235` | `pub async fn new_streamable_http_client(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:290` | `pub async fn initialize(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:363` | `pub async fn list_tools(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:376` | `pub async fn list_tools_with_connector_ids(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:416` | `pub async fn list_resources(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:430` | `pub async fn list_resource_templates(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:444` | `pub async fn read_resource(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:457` | `pub async fn call_tool(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:484` | `pub async fn send_custom_notification(` |
| `pub_fn` | `codex-rs/rmcp-client/src/rmcp_client.rs:500` | `pub async fn send_custom_request(` |
| `pub_struct` | `codex-rs/secrets/src/lib.rs:22` | `pub struct SecretName(String);` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:25` | `pub fn new(raw: &str) -> Result<Self> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:37` | `pub fn as_str(&self) -> &str {` |
| `pub_enum` | `codex-rs/secrets/src/lib.rs:49` | `pub enum SecretScope {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:55` | `pub fn environment(environment_id: impl Into<String>) -> Result<Self> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:62` | `pub fn canonical_key(&self, name: &SecretName) -> String {` |
| `pub_struct` | `codex-rs/secrets/src/lib.rs:74` | `pub struct SecretListEntry {` |
| `pub_enum` | `codex-rs/secrets/src/lib.rs:81` | `pub enum SecretsBackendKind {` |
| `pub_trait` | `codex-rs/secrets/src/lib.rs:86` | `pub trait SecretsBackend: Send + Sync {` |
| `pub_struct` | `codex-rs/secrets/src/lib.rs:94` | `pub struct SecretsManager {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:99` | `pub fn new(codex_home: PathBuf, backend_kind: SecretsBackendKind) -> Self {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:109` | `pub fn new_with_keyring_store(` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:122` | `pub fn set(&self, scope: &SecretScope, name: &SecretName, value: &str) -> Result<()> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:126` | `pub fn get(&self, scope: &SecretScope, name: &SecretName) -> Result<Option<String>> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:130` | `pub fn delete(&self, scope: &SecretScope, name: &SecretName) -> Result<bool> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:134` | `pub fn list(&self, scope_filter: Option<&SecretScope>) -> Result<Vec<SecretListEntry>> {` |
| `pub_fn` | `codex-rs/secrets/src/lib.rs:139` | `pub fn environment_id_from_cwd(cwd: &Path) -> String {` |
| `pub_struct` | `codex-rs/secrets/src/local.rs:55` | `pub struct LocalSecretsBackend {` |
| `pub_fn` | `codex-rs/secrets/src/local.rs:61` | `pub fn new(codex_home: PathBuf, keyring_store: Arc<dyn KeyringStore>) -> Self {` |
| `pub_fn` | `codex-rs/secrets/src/local.rs:68` | `pub fn set(&self, scope: &SecretScope, name: &SecretName, value: &str) -> Result<()> {` |
| `pub_fn` | `codex-rs/secrets/src/local.rs:76` | `pub fn get(&self, scope: &SecretScope, name: &SecretName) -> Result<Option<String>> {` |
| `pub_fn` | `codex-rs/secrets/src/local.rs:82` | `pub fn delete(&self, scope: &SecretScope, name: &SecretName) -> Result<bool> {` |
| `pub_fn` | `codex-rs/secrets/src/local.rs:92` | `pub fn list(&self, scope_filter: Option<&SecretScope>) -> Result<Vec<SecretListEntry>> {` |
| `pub_fn` | `codex-rs/state/src/extract.rs:15` | `pub fn apply_rollout_item(` |
| `pub_mod` | `codex-rs/state/src/lib.rs:8` | `pub mod log_db;` |
| `pub_const` | `codex-rs/state/src/lib.rs:40` | `pub const DB_ERROR_METRIC: &str = "codex.db.error";` |
| `pub_const` | `codex-rs/state/src/lib.rs:42` | `pub const DB_METRIC_BACKFILL: &str = "codex.db.backfill";` |
| `pub_const` | `codex-rs/state/src/lib.rs:44` | `pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "codex.db.backfill.duration_ms";` |
| `pub_const` | `codex-rs/state/src/lib.rs:46` | `pub const DB_METRIC_COMPARE_ERROR: &str = "codex.db.compare_error";` |
...
| `pub_struct` | `codex-rs/state/src/model/backfill_state.rs:9` | `pub struct BackfillState {` |
| `pub_enum` | `codex-rs/state/src/model/backfill_state.rs:45` | `pub enum BackfillStatus {` |
| `pub_const` | `codex-rs/state/src/model/backfill_state.rs:52` | `pub const fn as_str(self) -> &'static str {` |
| `pub_fn` | `codex-rs/state/src/model/backfill_state.rs:60` | `pub fn parse(value: &str) -> Result<Self> {` |
...
| `pub_struct` | `codex-rs/state/src/model/thread_memory.rs:10` | `pub struct ThreadMemory {` |
...
| `pub_struct` | `codex-rs/state/src/model/thread_metadata.rs:93` | `pub struct ThreadMetadataBuilder {` |
| `pub_fn` | `codex-rs/state/src/model/thread_metadata.rs:126` | `pub fn new(` |
| `pub_fn` | `codex-rs/state/src/model/thread_metadata.rs:151` | `pub fn build(&self, default_provider: &str) -> ThreadMetadata {` |
| `pub_fn` | `codex-rs/state/src/model/thread_metadata.rs:187` | `pub fn diff_fields(&self, other: &Self) -> Vec<&'static str> {` |
| `pub_struct` | `codex-rs/state/src/model/thread_metadata.rs:358` | `pub struct BackfillStats {` |
| `pub_const` | `codex-rs/state/src/runtime.rs:40` | `pub const STATE_DB_FILENAME: &str = "state";` |
| `pub_const` | `codex-rs/state/src/runtime.rs:41` | `pub const STATE_DB_VERSION: u32 = 4;` |
| `pub_struct` | `codex-rs/state/src/runtime.rs:46` | `pub struct StateRuntime {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:56` | `pub async fn init(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:90` | `pub fn codex_home(&self) -> &Path {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:95` | `pub async fn get_backfill_state(&self) -> anyhow::Result<crate::BackfillState> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:110` | `pub async fn mark_backfill_running(&self) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:127` | `pub async fn checkpoint_backfill(&self, watermark: &str) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:145` | `pub async fn mark_backfill_complete(&self, last_watermark: Option<&str>) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:169` | `pub async fn get_thread(&self, id: ThreadId) -> anyhow::Result<Option<crate::ThreadMetadata>> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:202` | `pub async fn get_dynamic_tools(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:234` | `pub async fn get_thread_memory(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:254` | `pub async fn find_rollout_path_by_id(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:278` | `pub async fn list_threads(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:344` | `pub async fn insert_log(&self, entry: &LogEntry) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:349` | `pub async fn insert_logs(&self, entries: &[LogEntry]) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:381` | `pub async fn query_logs(&self, query: &LogQuery) -> anyhow::Result<Vec<LogRow>> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:403` | `pub async fn max_log_id(&self, query: &LogQuery) -> anyhow::Result<i64> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:413` | `pub async fn list_thread_ids(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:443` | `pub async fn upsert_thread(&self, metadata: &crate::ThreadMetadata) -> anyhow::Result<()> {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:512` | `pub async fn upsert_thread_memory(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:553` | `pub async fn get_last_n_thread_memories_for_cwd(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:590` | `pub async fn persist_dynamic_tools(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:631` | `pub async fn apply_rollout_items(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:674` | `pub async fn mark_archived(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:698` | `pub async fn mark_unarchived(` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:823` | `pub fn state_db_filename() -> String {` |
| `pub_fn` | `codex-rs/state/src/runtime.rs:827` | `pub fn state_db_path(codex_home: &Path) -> PathBuf {` |
...
| `pub_struct` | `codex-rs/tui/src/app.rs:113` | `pub struct AppExitInfo {` |
| `pub_fn` | `codex-rs/tui/src/app.rs:122` | `pub fn fatal(message: impl Into<String>) -> Self {` |
| `pub_enum` | `codex-rs/tui/src/app.rs:140` | `pub enum ExitReason {` |
| `pub_fn` | `codex-rs/tui/src/app.rs:593` | `pub fn chatwidget_init_for_forked_or_resumed_thread(` |
| `pub_fn` | `codex-rs/tui/src/app.rs:917` | `pub async fn run(` |
| `fn_main` | `codex-rs/tui/src/bin/md-events.rs:4` | `fn main() {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/approval_overlay.rs:74` | `pub fn new(request: ApprovalRequest, app_event_tx: AppEventSender, features: Features) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/approval_overlay.rs:90` | `pub fn enqueue_request(&mut self, req: ApprovalRequest) {` |
| `pub_enum` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:186` | `pub enum InputResult {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:331` | `pub fn new(` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:410` | `pub fn set_skill_mentions(&mut self, skills: Option<Vec<SkillMetadata>>) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:418` | `pub fn set_image_paste_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:422` | `pub fn set_connector_mentions(&mut self, connectors_snapshot: Option<ConnectorsSnapshot>) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:449` | `pub fn set_steer_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:453` | `pub fn set_collaboration_modes_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:457` | `pub fn set_connectors_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:461` | `pub fn set_collaboration_mode_indicator(` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:468` | `pub fn set_personality_command_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:484` | `pub fn set_windows_degraded_sandbox_active(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:565` | `pub fn handle_paste(&mut self, pasted: String) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:586` | `pub fn handle_paste_image_path(&mut self, pasted: String) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:914` | `pub fn attach_image(&mut self, path: PathBuf) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:925` | `pub fn take_recent_submission_images(&mut self) -> Vec<PathBuf> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:930` | `pub fn take_recent_submission_images_with_placeholders(&mut self) -> Vec<LocalImageAttachment> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:992` | `pub fn show_quit_shortcut_hint(&mut self, key: KeyBinding, has_focus: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:1002` | `pub fn clear_quit_shortcut_hint(&mut self, has_focus: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:1035` | `pub fn handle_key_event(&mut self, key_event: KeyEvent) -> (InputResult, bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:1650` | `pub fn skills(&self) -> Option<&Vec<SkillMetadata>> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer.rs:3121` | `pub fn set_task_running(&mut self, running: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:90` | `pub fn new() -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:102` | `pub fn set_metadata(&mut self, log_id: u64, entry_count: usize) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:113` | `pub fn record_local_submission(&mut self, entry: HistoryEntry) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:134` | `pub fn reset_navigation(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:141` | `pub fn should_handle_navigation(&self, text: &str, cursor: usize) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:162` | `pub fn navigate_up(&mut self, app_event_tx: &AppEventSender) -> Option<HistoryEntry> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:179` | `pub fn navigate_down(&mut self, app_event_tx: &AppEventSender) -> Option<HistoryEntry> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/chat_composer_history.rs:206` | `pub fn on_entry_response(` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/list_selection_view.rs:130` | `pub fn new(params: SelectionViewParams, app_event_tx: AppEventSender) -> Self {` |
| `pub_mod` | `codex-rs/tui/src/bottom_pane/mod.rs:68` | `pub mod custom_prompt_view;` |
| `pub_mod` | `codex-rs/tui/src/bottom_pane/mod.rs:90` | `pub mod popup_consts;` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:181` | `pub fn new(params: BottomPaneParams) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:220` | `pub fn set_skills(&mut self, skills: Option<Vec<SkillMetadata>>) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:228` | `pub fn set_image_paste_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:233` | `pub fn set_connectors_snapshot(&mut self, snapshot: Option<ConnectorsSnapshot>) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:238` | `pub fn take_mention_bindings(&mut self) -> Vec<MentionBinding> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:242` | `pub fn take_recent_submission_mention_bindings(&mut self) -> Vec<MentionBinding> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:253` | `pub fn set_steer_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:257` | `pub fn set_collaboration_modes_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:262` | `pub fn set_connectors_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:267` | `pub fn set_windows_degraded_sandbox_active(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:272` | `pub fn set_collaboration_mode_indicator(` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:280` | `pub fn set_personality_command_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:285` | `pub fn status_widget(&self) -> Option<&StatusIndicatorWidget> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:289` | `pub fn skills(&self) -> Option<&Vec<SkillMetadata>> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:313` | `pub fn handle_key_event(&mut self, key_event: KeyEvent) -> InputResult {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:408` | `pub fn handle_paste(&mut self, pasted: String) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:592` | `pub fn set_task_running(&mut self, running: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:713` | `pub fn push_approval_request(&mut self, request: ApprovalRequest, features: &Features) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/mod.rs:733` | `pub fn push_user_input_request(&mut self, request: RequestUserInputEvent) {` |
| `pub_type` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:75` | `pub type ChangeCallBack = Box<dyn Fn(&[MultiSelectItem], &AppEventSender) + Send + Sync>;` |
| `pub_type` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:79` | `pub type ConfirmCallback = Box<dyn Fn(&[String], &AppEventSender) + Send + Sync>;` |
| `pub_type` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:82` | `pub type CancelCallback = Box<dyn Fn(&AppEventSender) + Send + Sync>;` |
| `pub_type` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:86` | `pub type PreviewCallback = Box<dyn Fn(&[MultiSelectItem]) -> Option<Line<'static>> + Send + Sync>;` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:170` | `pub fn builder(` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:395` | `pub fn close(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:635` | `pub fn new(title: String, subtitle: Option<String>, app_event_tx: AppEventSender) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:651` | `pub fn items(mut self, items: Vec<MultiSelectItem>) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:660` | `pub fn instructions(mut self, instructions: Vec<Span<'static>>) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:668` | `pub fn enable_ordering(mut self) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/multi_select_picker.rs:721` | `pub fn build(self) -> MultiSelectPicker {` |
...
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:63` | `pub fn new() -> Self {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:76` | `pub fn set_text_clearing_elements(&mut self, text: &str) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:81` | `pub fn set_text_with_elements(&mut self, text: &str, elements: &[UserTextElement]) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:115` | `pub fn text(&self) -> &str {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:119` | `pub fn insert_str(&mut self, text: &str) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:123` | `pub fn insert_str_at(&mut self, pos: usize, text: &str) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:134` | `pub fn replace_range(&mut self, range: std::ops::Range<usize>, text: &str) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:172` | `pub fn cursor(&self) -> usize {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:176` | `pub fn set_cursor(&mut self, pos: usize) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:182` | `pub fn desired_height(&self, width: u16) -> u16 {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:187` | `pub fn cursor_pos(&self, area: Rect) -> Option<(u16, u16)> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:192` | `pub fn cursor_pos_with_state(&self, area: Rect, state: TextAreaState) -> Option<(u16, u16)> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:205` | `pub fn is_empty(&self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:258` | `pub fn input(&mut self, event: KeyEvent) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:497` | `pub fn delete_backward(&mut self, n: usize) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:511` | `pub fn delete_forward(&mut self, n: usize) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:525` | `pub fn delete_backward_word(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:535` | `pub fn delete_forward_word(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:542` | `pub fn kill_to_end_of_line(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:559` | `pub fn kill_to_beginning_of_line(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:572` | `pub fn yank(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:596` | `pub fn move_cursor_left(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:602` | `pub fn move_cursor_right(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:607` | `pub fn move_cursor_up(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:670` | `pub fn move_cursor_down(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:738` | `pub fn move_cursor_to_beginning_of_line(&mut self, move_up_at_bol: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:748` | `pub fn move_cursor_to_end_of_line(&mut self, move_down_at_eol: bool) {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:760` | `pub fn element_payloads(&self) -> Vec<String> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:767` | `pub fn text_elements(&self) -> Vec<UserTextElement> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:809` | `pub fn replace_element_payload(&mut self, old: &str, new: &str) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:874` | `pub fn insert_element(&mut self, text: &str) -> u64 {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:888` | `pub fn add_element_range(&mut self, range: Range<usize>) -> Option<u64> {` |
| `pub_fn` | `codex-rs/tui/src/bottom_pane/textarea.rs:917` | `pub fn remove_element_range(&mut self, range: Range<usize>) -> bool {` |
...
| `pub_mod` | `codex-rs/tui/src/lib.rs:68` | `pub mod custom_terminal;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:79` | `pub mod insert_history;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:81` | `pub mod live_wrap;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:88` | `pub mod onboarding;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:91` | `pub mod public_widgets;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:108` | `pub mod update_action;` |
| `pub_mod` | `codex-rs/tui/src/lib.rs:116` | `pub mod test_backend;` |
| `pub_fn` | `codex-rs/tui/src/lib.rs:127` | `pub async fn run_main(` |
| `pub_enum` | `codex-rs/tui/src/lib.rs:834` | `pub enum LoginStatus {` |
...
| `pub_struct` | `codex-rs/tui/src/oss_selection.rs:80` | `pub struct OssSelectionWidget<'a> {` |
| `pub_fn` | `codex-rs/tui/src/oss_selection.rs:159` | `pub fn handle_key_event(&mut self, key: KeyEvent) -> Option<String> {` |
| `pub_fn` | `codex-rs/tui/src/oss_selection.rs:223` | `pub fn is_complete(&self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/oss_selection.rs:227` | `pub fn desired_height(&self, width: u16) -> u16 {` |
| `pub_fn` | `codex-rs/tui/src/oss_selection.rs:290` | `pub async fn select_oss_provider(codex_home: &std::path::Path) -> io::Result<String> {` |
...
| `pub_enum` | `codex-rs/tui/src/resume_picker.rs:43` | `pub enum SessionSelection {` |
| `pub_enum` | `codex-rs/tui/src/resume_picker.rs:51` | `pub enum SessionPickerAction {` |
| `pub_fn` | `codex-rs/tui/src/resume_picker.rs:115` | `pub async fn run_resume_picker(` |
| `pub_fn` | `codex-rs/tui/src/resume_picker.rs:131` | `pub async fn run_fork_picker(` |
| `pub_enum` | `codex-rs/tui/src/slash_command.rs:12` | `pub enum SlashCommand {` |
| `pub_fn` | `codex-rs/tui/src/slash_command.rs:52` | `pub fn description(self) -> &'static str {` |
| `pub_fn` | `codex-rs/tui/src/slash_command.rs:90` | `pub fn command(self) -> &'static str {` |
| `pub_fn` | `codex-rs/tui/src/slash_command.rs:95` | `pub fn supports_inline_args(self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/slash_command.rs:103` | `pub fn available_during_task(self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/slash_command.rs:149` | `pub fn built_in_slash_commands() -> Vec<(&'static str, SlashCommand)> {` |
...
| `pub_type` | `codex-rs/tui/src/tui.rs:60` | `pub type Terminal = CustomTerminal<CrosstermBackend<Stdout>>;` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:62` | `pub fn set_modes() -> Result<()> {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:141` | `pub fn restore() -> Result<()> {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:147` | `pub fn restore_keep_raw() -> Result<()> {` |
| `pub_enum` | `codex-rs/tui/src/tui.rs:153` | `pub enum RestoreMode {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:208` | `pub fn init() -> Result<Terminal> {` |
| `pub_enum` | `codex-rs/tui/src/tui.rs:235` | `pub enum TuiEvent {` |
| `pub_struct` | `codex-rs/tui/src/tui.rs:241` | `pub struct Tui {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:261` | `pub fn new(terminal: Terminal) -> Self {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:290` | `pub fn set_alt_screen_enabled(&mut self, enabled: bool) {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:294` | `pub fn set_notification_method(&mut self, method: NotificationMethod) {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:298` | `pub fn frame_requester(&self) -> FrameRequester {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:302` | `pub fn enhanced_keys_supported(&self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:306` | `pub fn is_alt_screen_active(&self) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:311` | `pub fn pause_events(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:317` | `pub fn resume_events(&mut self) {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:362` | `pub fn notify(&mut self, message: impl AsRef<str>) -> bool {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:387` | `pub fn event_stream(&self) -> Pin<Box<dyn Stream<Item = TuiEvent> + Send + 'static>> {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:407` | `pub fn enter_alt_screen(&mut self) -> Result<()> {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:429` | `pub fn leave_alt_screen(&mut self) -> Result<()> {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:443` | `pub fn insert_history_lines(&mut self, lines: Vec<Line<'static>>) {` |
| `pub_fn` | `codex-rs/tui/src/tui.rs:448` | `pub fn draw(` |
...
| `pub_fn` | `codex-rs/tui/src/updates.rs:139` | `pub fn get_upgrade_version_for_popup(config: &Config) -> Option<String> {` |
| `pub_fn` | `codex-rs/tui/src/updates.rs:157` | `pub async fn dismiss_version(config: &Config, version: &str) -> anyhow::Result<()> {` |
...
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:125` | `pub fn terminate_process_group(process_group_id: u32) -> io::Result<bool> {` |
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:143` | `pub fn terminate_process_group(_process_group_id: u32) -> io::Result<bool> {` |
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:149` | `pub fn kill_process_group(process_group_id: u32) -> io::Result<()> {` |
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:166` | `pub fn kill_process_group(_process_group_id: u32) -> io::Result<()> {` |
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:172` | `pub fn kill_child_process_group(child: &mut Child) -> io::Result<()> {` |
| `pub_fn` | `codex-rs/utils/pty/src/process_group.rs:182` | `pub fn kill_child_process_group(_child: &mut Child) -> io::Result<()> {` |
...
| `pub_fn` | `codex-rs/utils/string/src/lib.rs:42` | `pub fn sanitize_metric_tag_value(value: &str) -> String {` |
...
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/audit.rs:87` | `pub fn audit_everyone_writable(` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/audit.rs:213` | `pub fn apply_world_writable_scan_and_denies(` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/audit.rs:239` | `pub fn apply_capability_denies_for_world_writable(` |
...
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/cap.rs:15` | `pub struct CapSids {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/cap.rs:27` | `pub fn cap_sid_file(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/cap.rs:49` | `pub fn load_or_create_cap_sids(codex_home: &Path) -> Result<CapSids> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/cap.rs:79` | `pub fn workspace_cap_sid_for_cwd(codex_home: &Path, cwd: &Path) -> Result<String> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/command_runner_win.rs:91` | `pub fn main() -> Result<()> {` |
...
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/elevated_impl.rs:507` | `pub struct CaptureResult {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/elevated_impl.rs:515` | `pub fn run_windows_sandbox_capture(` |
...
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/lib.rs:224` | `pub struct CaptureResult {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/lib.rs:231` | `pub fn run_windows_sandbox_capture(` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/lib.rs:545` | `pub struct CaptureResult {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/lib.rs:552` | `pub fn run_windows_sandbox_capture(` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/lib.rs:564` | `pub fn apply_world_writable_scan_and_denies(` |
...
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/path_normalization.rs:4` | `pub fn canonicalize_path(path: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/path_normalization.rs:8` | `pub fn canonical_path_key(path: &Path) -> String {` |
...
| `pub_enum` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:16` | `pub enum SetupErrorCode {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:72` | `pub fn as_str(self) -> &'static str {` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:106` | `pub struct SetupErrorReport {` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:112` | `pub struct SetupFailure {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:118` | `pub fn new(code: SetupErrorCode, message: impl Into<String>) -> Self {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:125` | `pub fn from_report(report: SetupErrorReport) -> Self {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:129` | `pub fn metric_message(&self) -> String {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:142` | `pub fn failure(code: SetupErrorCode, message: impl Into<String>) -> anyhow::Error {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:146` | `pub fn extract_failure(err: &anyhow::Error) -> Option<&SetupFailure> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:150` | `pub fn setup_error_path(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:154` | `pub fn clear_setup_error_report(codex_home: &Path) -> Result<()> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:163` | `pub fn write_setup_error_report(codex_home: &Path, report: &SetupErrorReport) -> Result<()> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:173` | `pub fn read_setup_error_report(codex_home: &Path) -> Result<Option<SetupErrorReport>> {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_error.rs:186` | `pub fn sanitize_setup_metric_tag_value(value: &str) -> String {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_main_win.rs:343` | `pub fn main() -> Result<()> {` |
| `pub_const` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:35` | `pub const SETUP_VERSION: u32 = 5;` |
| `pub_const` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:36` | `pub const OFFLINE_USERNAME: &str = "CodexSandboxOffline";` |
| `pub_const` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:37` | `pub const ONLINE_USERNAME: &str = "CodexSandboxOnline";` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:42` | `pub fn sandbox_dir(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:46` | `pub fn sandbox_secrets_dir(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:50` | `pub fn setup_marker_path(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:54` | `pub fn sandbox_users_path(codex_home: &Path) -> PathBuf {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:58` | `pub fn run_setup_refresh(` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:129` | `pub struct SetupMarker {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:138` | `pub fn version_matches(&self) -> bool {` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:144` | `pub struct SandboxUserRecord {` |
| `pub_struct` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:151` | `pub struct SandboxUsersFile {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:158` | `pub fn version_matches(&self) -> bool {` |
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/setup_orchestrator.rs:450` | `pub fn run_elevated_setup(` |
...
| `pub_fn` | `codex-rs/windows-sandbox-rs/src/workspace_acl.rs:7` | `pub fn is_command_cwd_root(root: &Path, canonical_command_cwd: &Path) -> bool {` |

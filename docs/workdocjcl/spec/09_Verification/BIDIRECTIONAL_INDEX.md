...
- generated_utc: `2026-02-03T09:50:26Z`
- repo_file_count: `2431` (from `workdocjcl/inventory/file_manifest_repo.txt`)
...
## 1. 生成物
- 文件到规格映射（机器可读）：`workdocjcl/spec/09_Verification/file_to_spec_map.json`
- 文件胶囊索引：`workdocjcl/spec/10_File_Specs/INDEX.md`
- Rust crate 索引：`workdocjcl/spec/11_Rust_Crate_Specs/INDEX.md`
- Node package 索引：`workdocjcl/spec/12_Node_Package_Specs/INDEX.md`
...
- `codex-api`: 27 files
- `codex-app-server`: 69 files
- `codex-app-server-protocol`: 563 files
- `codex-app-server-test-client`: 5 files
...
- `codex-rmcp-client`: 14 files
- `codex-state`: 16 files
